...
block|}
block|}
comment|//private String repositoryURL = "https://support.syntactica.com/exist_svn/";
specifier|private
name|String
name|myRepositoryURL
init|=
literal|"file://localhost/srv/"
decl_stmt|;
specifier|private
name|boolean
name|local
...
argument_list|()
expr_stmt|;
comment|//load configuration for data generation
name|String
name|configFilePath
init|=
literal|"org/exist/versioning/svn/generate.xml"
decl_stmt|;
name|InputStream
name|is
init|=
...
argument_list|)
expr_stmt|;
comment|//        repository.getChangelists(collectionURL, null, SVNDepth.INFINITY);
try|try
block|{
name|Thread
operator|.
