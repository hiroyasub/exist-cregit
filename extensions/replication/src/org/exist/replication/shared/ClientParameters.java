...
block|}
block|}
comment|/**      *  Retrieve initial context properties, e.g. {@link Context.INITIAL_CONTEXT_FACTORY}      * and {@link Context.PROVIDER_URL}. Only properties with key starting with      * ".java" are added to the result.      */
specifier|public
name|Properties
