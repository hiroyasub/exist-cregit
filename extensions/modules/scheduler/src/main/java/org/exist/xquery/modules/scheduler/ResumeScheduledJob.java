...
begin_comment
comment|/**  * eXist Scheduler Module Extension ResumeScheduledJob.  *  * Resumes a Job with the Scheduler  *  * @author<a href="mailto:adam.retter@devon.gov.uk">Adam Retter</a>  * @version  1.0  * @see      org.exist.xquery.BasicFunction#BasicFunction(org.exist.xquery.XQueryContext, org.exist.xquery.FunctionSignature)  * @serial   2006-11-15  */
end_comment
