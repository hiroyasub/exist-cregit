...
argument_list|)
argument_list|,
literal|"Open's a mail store. $a is a mail session handle. Host/User/Password/Protocol values will be obtained from the session. Returns an xs:long representing the store handle."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Closes's a mail store. $a is a mail store handle."
argument_list|,
operator|new
name|SequenceType
index|[]
