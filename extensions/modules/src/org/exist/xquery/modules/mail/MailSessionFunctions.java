...
argument_list|)
argument_list|,
literal|"Open's a mail session. $a defines optional JavaMail session properties in the form<properties><property name=\"\" value=\"\"/></properties>.. Returns an xs:long representing the session handle."
argument_list|,
operator|new
name|SequenceType
index|[]
