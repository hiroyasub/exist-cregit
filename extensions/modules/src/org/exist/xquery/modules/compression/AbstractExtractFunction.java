...
argument_list|)
throw|;
comment|//        SequenceType[] argTypes = entryFilterFunctionSig.getArgumentTypes();
comment|//        if(
comment|//            argTypes[0].getCardinality() != Cardinality.EXACTLY_ONE || !Type.subTypeOf(Type.ANY_URI, argTypes[0].getPrimaryType()) ||
comment|//            argTypes[1].getCardinality() != Cardinality.EXACTLY_ONE || !Type.subTypeOf(Type.STRING, argTypes[1].getPrimaryType()) ||
comment|//            argTypes[2].getCardinality() != Cardinality.ZERO_OR_MORE || !Type.subTypeOf(Type.ANY_TYPE, argTypes[2].getPrimaryType()) ||
comment|//            !Type.subTypeOf(Type.BOOLEAN, entryFilterFunctionSig.getReturnType().getPrimaryType())
comment|//        ) throw new XPathException("entry-filter function does not match the expected function signature.");
name|filterParam
operator|=
name|args
index|[
...
argument_list|)
throw|;
comment|//        argTypes = entryDataFunctionSig.getArgumentTypes();
comment|//        if(
comment|//                argTypes[0].getCardinality() != Cardinality.EXACTLY_ONE || !Type.subTypeOf(Type.ANY_URI, argTypes[0].getPrimaryType()) ||
comment|//                argTypes[1].getCardinality() != Cardinality.EXACTLY_ONE || !Type.subTypeOf(Type.STRING, argTypes[1].getPrimaryType()) ||
comment|//                argTypes[2].getCardinality() != Cardinality.ZERO_OR_ONE || !Type.subTypeOf(Type.ITEM, argTypes[2].getPrimaryType()) ||
comment|//                argTypes[3].getCardinality() != Cardinality.ZERO_OR_MORE || !Type.subTypeOf(Type.ANY_TYPE, argTypes[3].getPrimaryType())
comment|//        ) throw new XPathException("entry-data function does not match the expected function signature.");
name|storeParam
operator|=
name|args
index|[
