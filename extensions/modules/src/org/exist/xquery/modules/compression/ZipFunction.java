...
argument_list|)
argument_list|,
literal|"Gzip's the $a resource. $a is a URI of gzipped resource."
argument_list|,
operator|new
name|SequenceType
index|[]
...
return|;
block|}
comment|/**      * Adds a document to a Gzip      *       * @param gzos The Gzip Output Stream to add the document to      * @param doc The document to add to the Gzip      */
specifier|private
name|void
name|gzipResource
parameter_list|(
...
name|SAXException
block|{
comment|//add the document to the Gzip
if|if
condition|(
name|doc
operator|.
