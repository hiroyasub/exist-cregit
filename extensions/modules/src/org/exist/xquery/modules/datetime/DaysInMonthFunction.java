...
argument_list|)
argument_list|,
literal|"Returns the number of days in the month of the given date."
argument_list|,
operator|new
name|SequenceType
index|[]
...
name|EXACTLY_ONE
argument_list|,
literal|"The date that is within the month that the count of the number of days is to be given."
argument_list|)
block|}
argument_list|,
operator|new
