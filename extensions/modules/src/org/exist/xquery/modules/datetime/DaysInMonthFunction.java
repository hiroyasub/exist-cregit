...
begin_comment
comment|/**  * @author Adam Retter<adam.retter@exist-db.org>  * @version 1.1  */
end_comment
...
argument_list|)
argument_list|,
literal|"Returns the number of days in the month of the date."
argument_list|,
operator|new
name|SequenceType
index|[]
...
name|EXACTLY_ONE
argument_list|,
literal|"The date for extracting the number of days in the month component."
argument_list|)
block|}
argument_list|,
operator|new
