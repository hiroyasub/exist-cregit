...
argument_list|)
argument_list|,
literal|"Get's the Height of the image passed in, returning an integer of the images Height in pixels or an empty sequence if $a is invalid."
argument_list|,
operator|new
name|SequenceType
index|[]
