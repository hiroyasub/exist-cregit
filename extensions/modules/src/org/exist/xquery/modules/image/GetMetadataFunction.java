...
argument_list|)
argument_list|,
literal|"Gets the exif metadata of the image passed in, only suitable for exif providers e.g. JPEG."
argument_list|,
operator|new
name|SequenceType
index|[]
...
name|forName
argument_list|(
literal|"org.apache.tika.parser.jpeg.JpegParser"
argument_list|)
operator|.
name|newInstance
argument_list|()
...
name|forName
argument_list|(
literal|"org.apache.tika.metadata.Metadata"
argument_list|)
operator|.
name|newInstance
argument_list|()
