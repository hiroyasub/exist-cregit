...
argument_list|)
argument_list|,
literal|"Delete a JNDI Directory entry. $a is the directory context handle from a jndi:get-dir-context() call. $b is the DN."
argument_list|,
operator|new
name|SequenceType
index|[]
...
name|error
argument_list|(
literal|"jndi:delete() - Invalid JNDI context handle provided: "
operator|+
name|ctxID
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"jndi:delete() Delete failed for dn ["
operator|+
name|dn
operator|+
literal|"]: "
