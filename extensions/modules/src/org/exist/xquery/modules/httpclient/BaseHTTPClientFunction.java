...
expr_stmt|;
block|}
comment|/**      * Parses header parameters and sets them on the Request.      *      * @param   method   The Http Method to set the request headers on      * @param   headers  The headers node e.g.<headers><header name="Content-Type" value="application/xml"/></headers>      *      * @throws  XPathException  DOCUMENT ME!      */
specifier|protected
name|void
name|setHeaders
parameter_list|(
...
block|}
block|}
comment|/**      * Performs a HTTP Request.      *      * @param   context         The context of the calling XQuery      * @param   method          The HTTP methor for the request      * @param   persistCookies  If true existing cookies are re-used and any issued cookies are persisted for future HTTP Requests      *      * @return  DOCUMENT ME!      *      * @throws  IOException     DOCUMENT ME!      * @throws  XPathException  DOCUMENT ME!      */
specifier|protected
name|Sequence
name|doRequest
parameter_list|(
...
return|;
block|}
comment|/**      * Takes the HTTP Response and encodes it as an XML structure.      *      * @param   context     The context of the calling XQuery      * @param   method      The HTTP Request Method      * @param   statusCode  The status code returned from the http method invocation      *      * @return  The data in XML format      *      * @throws  XPathException  DOCUMENT ME!      * @throws  IOException     DOCUMENT ME!      */
specifier|private
name|Sequence
name|encodeResponseAsXML
parameter_list|(
...
return|;
block|}
comment|/**      * Takes an exception message and encodes it as an XML response structure.      *      * @param   context  The context of the calling XQuery      * @param   message  The exception error message      *      * @return  The response in XML format      *      * @throws  IOException     DOCUMENT ME!      * @throws  XPathException  DOCUMENT ME!      */
specifier|private
name|Sequence
name|encodeErrorResponse
parameter_list|(
...
return|;
block|}
comment|/**      * Merges two cookie arrays together.      *      *<p>If cookies are equal (same name, path and comain) then the incoming cookie is favoured over the current cookie</p>      *      * @param   current   The cookies already known      * @param   incoming  The new cookies      *      * @return  DOCUMENT ME!      */
specifier|protected
name|Cookie
index|[]
name|mergeCookies
