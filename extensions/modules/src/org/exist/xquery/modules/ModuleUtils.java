...
return|;
block|}
comment|/** 	 * Takes a  InputStream of XML and Creates an XML Node from it using SAX in the 	 * context of the query 	 *  	 * @param context 	 *            The Context of the calling XQuery 	 * @param xml 	 *            The InputStream of XML 	 *  	 * @return The NodeValue of XML 	 */
specifier|public
specifier|static
name|NodeValue
name|streamToXML
