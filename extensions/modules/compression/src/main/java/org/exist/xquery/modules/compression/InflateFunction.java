...
name|EXACTLY_ONE
argument_list|,
literal|"The inflate data to uncompress."
argument_list|)
block|}
argument_list|,
operator|new
...
name|EXACTLY_ONE
argument_list|,
literal|"If true, expect raw deflate data that is not wrapped inside zlib header and checksum."
argument_list|)
block|}
argument_list|,
operator|new
...
name|XPathException
block|{
comment|// is there some data to inflate?
if|if
condition|(
name|args
index|[
