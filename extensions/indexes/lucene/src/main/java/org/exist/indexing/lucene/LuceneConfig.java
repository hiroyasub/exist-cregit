...
condition|)
block|{
comment|// Substitute<analyzer-id>:index with<analyzer-id>:query
name|String
name|qid
init|=
name|id
...
name|format
argument_list|(
literal|"Failed to substitute %s with %s analyzer"
argument_list|,
name|id
argument_list|,
name|qid
...
name|DatabaseConfigurationException
argument_list|(
literal|"Attribute prefix for<module> required"
argument_list|)
throw|;
block|}
if|if
...
name|DatabaseConfigurationException
argument_list|(
literal|"Attribute uri for<module> required"
argument_list|)
throw|;
block|}
block|}
