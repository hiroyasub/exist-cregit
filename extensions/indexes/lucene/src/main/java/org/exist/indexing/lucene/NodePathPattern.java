...
comment|// to skip the ( and )
block|}
comment|// So far we're supporting only `@attr OP 'value'` predicates, where OP is one of:
name|String
index|[]
name|ops
init|=
...
condition|)
block|{
comment|// as input should start with `@`
name|pcode
operator|=
name|pcodes
index|[
...
argument_list|()
decl_stmt|;
comment|// start at 1 to skip the leading `@`
name|String
name|val
init|=
name|input
