...
begin_comment
comment|/**  * Configuration for a field definition nested inside a lucene index configuration element.  * A field has a name and content returned by an XQuery expression. It may be associated with  * an analyzer, could have a type and may be stored or not.  *  * @author Wolfgang Meier  */
end_comment
