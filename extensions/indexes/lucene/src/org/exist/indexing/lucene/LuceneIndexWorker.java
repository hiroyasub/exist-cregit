...
begin_comment
comment|/**  * Class for handling all Lucene operations.  *  * @author Wolfgang Meier (wolfgang@exist-db.org)  * @author Dannes Wessels (dannes@exist-db.org)  */
end_comment
...
argument_list|()
decl_stmt|;
comment|//XXX: optimize  - put outside 'for'
name|controller
operator|.
name|streamMetas
argument_list|(
