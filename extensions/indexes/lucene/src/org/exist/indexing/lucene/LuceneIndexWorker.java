...
expr_stmt|;
block|}
comment|/*      * Adds the passed character sequence to the lucene index.      * This version needs the NodeImpl for node specific attribute match boosting.      *      * @param node      * @param nodeId      * @param qname      * @param path      * @param config      * @param content      */
specifier|protected
name|void
name|indexText
parameter_list|(
