...
return|;
block|}
comment|/**      * Test if an expression defined by the arguments matches this condition. Used by the query rewriter.      * @param lhe The QName of the attribute to test      * @param rhe The expected value of the attribute      * @param operator The operator of the comparison expression (defaults to equals for now)      * @return      */
specifier|public
name|boolean
name|find
parameter_list|(
