...
argument_list|)
argument_list|,
literal|"Returns all nodes from $a containing the string $b at any position. "
operator|+
literal|"Strings are compared case-insensitive."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns all nodes from $a ending with the string $b. "
operator|+
literal|"Strings are compared case-insensitive."
argument_list|,
operator|new
...
argument_list|)
argument_list|,
literal|"Returns all nodes from $a starting with the string $b. "
operator|+
literal|"Strings are compared case-insensitive."
argument_list|,
operator|new
...
argument_list|)
argument_list|,
literal|"Returns all nodes from $a whose string content equals $b. "
operator|+
literal|"Strings are compared case-insensitive"
argument_list|,
operator|new
