...
condition|)
block|{
comment|//Release the deferred element
...
condition|)
return|return;
comment|//We need to collect the retained element's attributes in order to feed the SAX handler
name|AttributesImpl
name|attList
init|=
...
argument_list|()
decl_stmt|;
comment|//Maybe we could assume a default value here
name|String
name|whatToPush
init|=
literal|null
...
name|geometry
expr_stmt|;
comment|//TODO : null geometries can't be returned for many reasons, including a (too) strict
