...
argument_list|)
argument_list|,
literal|"Returns the GML representation of a buffer around geometry $a having width $b in its CRS in the CRS specified by $c. "
operator|+
literal|"Curves will be represented by 8 segments per circle quadrant."
argument_list|,
operator|new
...
literal|"Curves will be represented by $c segments per circle quadrant."
operator|+
literal|"$d specifies the way line string ends are buffered : 1, as semi-circle, 2, as perpendicular straight lines, 3 as half-squares."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns the GML representation of the convex hull of geometry $a in the CRS specified by $b."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns the GML representation of the boundary of geometry $a in the CRS specified by $b."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns the GML representation of the intersection of geometry $a and geometry $b in the CRS specified by $b."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns the GML representation of the union of geometry $a and geometry $b in the CRS specified by $b."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns the GML representation of the difference of geometry $a and geometry $b in the CRS specified by $b."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
argument_list|,
literal|"Returns the GML representation of the symetric difference of geometry $a and geometry $b in the CRS specified by $b."
argument_list|,
operator|new
name|SequenceType
index|[]
...
argument_list|)
expr_stmt|;
comment|//Get the SRS which is the last argument iff it is a string
if|if
condition|(
name|Type
operator|.
...
expr_stmt|;
block|}
comment|//Keep the first SRS for future use
name|originSrsName
operator|=
name|srsName1
expr_stmt|;
