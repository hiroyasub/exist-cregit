...
begin_comment
comment|/**  *<!-- Category: instruction -->  *<xsl:non-matching-substring>  *<!-- Content: sequence-constructor -->  *</xsl:non-matching-substring>  *   * @author<a href="mailto:shabanovd@gmail.com">Dmitriy Shabanov</a>  *  */
end_comment
...
name|display
argument_list|(
literal|"<xsl:non-matching-substring"
argument_list|)
expr_stmt|;
name|dumper
operator|.
