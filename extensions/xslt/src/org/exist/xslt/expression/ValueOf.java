...
begin_comment
comment|/**  *<!-- Category: instruction -->  *<xsl:value-of  *   select? = expression  *   separator? = { string }  *   [disable-output-escaping]? = "yes" | "no">  *<!-- Content: sequence-constructor -->  *</xsl:value-of>  *   * @author shabanovd  *  */
end_comment
