...
begin_comment
comment|/**  *<!-- Category: declaration -->  *<xsl:decimal-format  *   name? = qname  *   decimal-separator? = char  *   grouping-separator? = char  *   infinity? = string  *   minus-sign? = char  *   NaN? = string  *   percent? = char  *   per-mille? = char  *   zero-digit? = char  *   digit? = char  *   pattern-separator? = char />  *   * @author shabanovd  *  */
end_comment
