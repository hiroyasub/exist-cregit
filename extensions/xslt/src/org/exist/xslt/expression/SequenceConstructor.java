...
begin_comment
comment|/**  *<!-- Category: instruction -->  *<xsl:sequence  *   select = expression>  *<!-- Content: xsl:fallback* -->  *</xsl:sequence>  *   * @author<a href="mailto:shabanovd@gmail.com">Dmitriy Shabanov</a>  *  */
end_comment
...
name|XPathException
block|{
comment|//    	boolean atRootCall = false;//XXX: rewrite
if|if
condition|(
name|attr_select
operator|!=
...
argument_list|)
expr_stmt|;
comment|//    	if (atRootCall)
comment|//    		contextInfo.addFlag(DOT_TEST);
block|}
specifier|public
name|Sequence
name|eval
