...
begin_comment
comment|/**  *<!-- Category: declaration -->  *<xsl:template  * 	match? = pattern  * 	name? = qname  * 	priority? = number  * 	mode? = tokens  * 	as? = sequence-type>  *<!-- Content: (xsl:param*, sequence-constructor) -->  *</xsl:template>  *   * @author shabanovd  *  */
end_comment
