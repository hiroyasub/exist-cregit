...
name|fatal
argument_list|(
literal|"index dropped on document in use, database corruption likely to follow: "
operator|+
name|docPath
argument_list|)
expr_stmt|;
...
try|try
block|{
comment|// It would be nicer to just try the lock here, and keep going if we can't get it, but oh well.
name|tx
operator|.
name|lockWrite
argument_list|(
