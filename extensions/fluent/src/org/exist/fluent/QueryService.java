...
name|MessageFormat
argument_list|(
literal|"{1,number,000} uses over {3,number,0.000}s ({7,number,0.000}s avg) ["
operator|+
literal|"{4,number,0.000}s compiling ({8,number,0.000}s avg, {2,number,percent} cache hits), "
operator|+
literal|"{5,number,0.000}s preparing ({9,number,0.000}s avg), {6,number,0.000}s executing ({10,number,0.000}s avg)"
operator|+
literal|"]: {0}"
argument_list|)
decl_stmt|;
