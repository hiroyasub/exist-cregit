...
return|;
block|}
comment|/** 	 * Clone this query service, optionally overriding the clone's namespace and variable bindings. 	 * If the namespace bindings override or variable bindings override is specified, then that object 	 * is used for its respective purpose (by reference).  If an override is not specified, the bindings 	 * are copied from the original query service (by value).  No concurrency control is applied to 	 * the overrides, so be careful in multi-threaded environments. 	 * 	 * @param nsBindingsOverride the namespace bindings to refer to from the clone, or<code>null</code> to copy from the original 	 * @param varBindingsOverride the variable bindings to refer to from the clone, or<code>null</code> to copy from the original 	 * @return a clone of this query service with optional bindings overridden 	 */
specifier|public
name|QueryService
name|clone
parameter_list|(
...
block|}
block|}
comment|/** 	 * @deprecated for testing only 	 */
annotation|@
name|Deprecated
specifier|public
specifier|static
