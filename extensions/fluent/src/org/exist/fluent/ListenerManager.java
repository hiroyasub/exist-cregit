...
block|{
return|return
literal|"<triggers><trigger event='store-document create-collection update-document rename-document rename-collection move-document move-collection remove-document remove-collection' class='org.exist.fluent.ListenerManager$TriggerDispatcher'/></triggers>"
return|;
block|}
specifier|static
class|class
