...
return|;
block|}
comment|/** 		 * Build a new XML document in this collection, with the given name.  Remember to {@link ElementBuilder#commit commit} 		 * commit the builder when done.  If the builder doesn't commit, no document is created. 		 *  		 * @param name the name to give the new document 		 * @return a builder to use to create the document 		 */
specifier|public
name|ElementBuilder
argument_list|<
name|XMLDocument
...
return|;
block|}
comment|/** 		 * Return whether this facet's folder immediately holds a document with the given name. 		 * 		 * @param name the name of the document to check for 		 * @return<code>true</code> if the folder directly contains a document with the given name,<code>false</code> otherwise 		 */
specifier|public
name|boolean
name|contains
parameter_list|(
...
return|;
block|}
comment|/** 		 * Create an XML document with the given name, takings its contents from the given source. 		 * 		 * @param name the desired name of the document 		 * @param source the source of XML data to read in the document contents from 		 * @return the newly created document 		 * @throws DatabaseException if anything else goes wrong 		 */
specifier|public
name|XMLDocument
name|load
parameter_list|(
...
return|;
block|}
comment|/** 		 * Create a binary document with the given name, takings its contents from the given source. 		 * 		 * @param name the desired name of the document 		 * @param source the source to read the document contents from 		 * @return the newly created document 		 * @throws DatabaseException if anything else goes wrong 		 */
specifier|public
name|Document
name|load
parameter_list|(
...
return|;
block|}
comment|/** 		 * Get the immediately contained document with the given name.  		 * 		 * @param name the name of the document to find 		 * @return the document with the given name 		 * @throws DatabaseException if unable to find or access the desired document 		 */
specifier|public
name|Document
name|get
parameter_list|(
...
block|}
comment|/** 	 * Delete this folder, including all documents and descendants. 	 */
specifier|public
name|void
name|delete
parameter_list|()
