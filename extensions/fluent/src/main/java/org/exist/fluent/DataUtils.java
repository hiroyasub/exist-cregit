...
return|;
block|}
comment|/** 	 * Convert a Java object to its equivalent XML datatype representation. 	 * At the moment, there is special treatment for<code>java.util.Date</code>, 	 *<code>java.util.Calendar</code> and<code>byte[]</code> (Base64 encoding); 	 * all other objects are simply passed through as-is. 	 *  	 * @param o the object to convert 	 * @return an XML representation of the object, according to XML Schema Datatype rules if possible 	 */
specifier|public
specifier|static
name|Object
name|toXMLObject
