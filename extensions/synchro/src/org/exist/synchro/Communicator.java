...
name|COMMUNICATOR
init|=
literal|"cluster.communicator"
decl_stmt|;
comment|//collection's events
comment|//create
specifier|protected
specifier|static
specifier|final
...
literal|19
decl_stmt|;
comment|//permissions's events //TODO: code
comment|//update
specifier|protected
specifier|static
specifier|final
name|short
name|BEFORE_UPDATE_PERMISSIONS
init|=
literal|10
decl_stmt|;
specifier|protected
...
name|getMethod
argument_list|(
literal|"beforeUpdateCollection"
argument_list|,
name|String
operator|.
name|class
...
argument_list|)
expr_stmt|;
comment|//initialize watcher triggers
name|Collection
name|collection
init|=
name|broker
...
argument_list|,
literal|"org.exist.synchro.WatchDocument"
argument_list|,
name|params
argument_list|)
expr_stmt|;
...
name|broker
argument_list|,
literal|"create-collection,rename-collection,delete-collection"
argument_list|,
literal|"org.exist.synchro.WatchCollection"
argument_list|,
name|params
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Changers watcher could not the initialized."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" before create collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" after create collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" before update collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" after update collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" before copy collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" after copy collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" before move collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" after move collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" before delete collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|" after delete collection uri = "
operator|+
name|uri
argument_list|)
expr_stmt|;
