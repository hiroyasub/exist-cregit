...
argument_list|)
expr_stmt|;
comment|//            checkIndex(docs, broker, new QName[] { new QName("head", "") }, "title", 1);
comment|//            checkIndex(docs, broker, new QName[] { new QName("p", "") }, "simple", 1);
comment|//            checkIndex(docs, broker, new QName[] { new QName("p", "") }, "mixed", 1);
comment|//            checkIndex(docs, broker, new QName[] { new QName("p", "") }, "dangerous", 1);
comment|//            checkIndex(docs, broker, new QName[] { new QName("p", "") }, "note", 0);
comment|//            checkIndex(docs, broker, new QName[] { new QName("p", "") }, "ignore", 0);
comment|//            checkIndex(docs, broker, new QName[] { new QName("p", "") }, "warnings", 1);
name|XQuery
name|xquery
init|=
name|broker
...
name|execute
argument_list|(
literal|"/article[ft:query(head, 'title AND status:draft')]"
argument_list|,
literal|null
argument_list|,
name|AccessContext
...
name|execute
argument_list|(
literal|"/article[ft:query(head, 'title AND status:final')]"
argument_list|,
literal|null
argument_list|,
name|AccessContext
...
name|execute
argument_list|(
literal|"/article[ft:query(head, 'title AND status:(final OR draft)')]"
argument_list|,
literal|null
argument_list|,
name|AccessContext
...
name|execute
argument_list|(
literal|"/article[ft:query(head, 'title AND status:another')]"
argument_list|,
literal|null
argument_list|,
name|AccessContext
