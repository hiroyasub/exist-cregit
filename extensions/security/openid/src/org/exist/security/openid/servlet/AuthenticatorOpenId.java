...
block|{
comment|//			req.setAttribute("identifier", identifier.getIdentifier());
comment|//			this.getServletContext().getRequestDispatcher("/openid/return.xql")
comment|//					.forward(req, resp);
name|resp
operator|.
name|sendRedirect
argument_list|(
literal|"openid/return.xql?identifier="
operator|+
name|identifier
operator|.
name|getIdentifier
