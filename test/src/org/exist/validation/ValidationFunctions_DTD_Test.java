...
name|query
argument_list|(
literal|"validation:validate('/db/validationtest/tmp/hamlet_valid.xml')"
argument_list|)
expr_stmt|;
name|r
operator|=
...
name|query
argument_list|(
literal|"validation:validate('/db/validationtest/hamlet_valid.xml',"
operator|+
...
name|query
argument_list|(
literal|"validation:validate('/db/validationtest/hamlet_invalid.xml',"
operator|+
literal|"'/db/validationtest/dtd/catalog.xml')"
argument_list|)
expr_stmt|;
