...
init|=
literal|"testValidationFunctionsXSD"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
expr_stmt|;
block|}
comment|/**      * NOTE - seems that a trailing '/' is needed on the Collection path when searching!      */
annotation|@
name|Test
specifier|public
name|void
name|xsd_SearchedGrammar
parameter_list|()
throws|throws
name|XPathException
throws|,
