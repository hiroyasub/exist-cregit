...
specifier|public
name|void
name|copyCollectionWithResource
parameter_list|()
throws|throws
name|XMLDBException
block|{
...
argument_list|)
decl_stmt|;
comment|//create resourcse owned by "test1", and group "users" in /db/securityTest3/source
name|Resource
name|resSource
init|=
name|source
