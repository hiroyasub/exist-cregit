...
begin_comment
comment|/**  * Test concurrent access to resources.  *   * @author wolf  */
end_comment
...
argument_list|)
expr_stmt|;
comment|//addAction(new XQueryAction(getUri + "/C1", "R1.xml", query0), 100, 1000, 100);
comment|//addAction(new XQueryAction(getUri + "/C1", "R1.xml", query1), 100, 1000, 100);
block|}
annotation|@
name|After
annotation|@
