...
begin_comment
comment|/**  * Module function definitions for performance test module.  *  * @author Wolfgang Meier (wolfgang@exist-db.org)  * @author ljo  */
end_comment
...
name|NAMESPACE_URI
init|=
literal|"http://exist-db.org/xquery/test/performance"
decl_stmt|;
specifier|public
specifier|final
specifier|static
...
block|{
return|return
literal|"A module for helper functions in the performance test suite."
return|;
block|}
specifier|public
name|String
