...
literal|"return\n"
operator|+
literal|"util:eval-and-serialize($query, ())"
decl_stmt|;
specifier|final
name|ResourceSet
name|result
...
specifier|public
name|void
name|evalAndSerializeDefaultOptions
parameter_list|()
throws|throws
name|XMLDBException
block|{
...
argument_list|)
expr_stmt|;
comment|// test that XQuery Prolog output options override the default provided options
name|query
operator|=
...
specifier|public
name|void
name|evalAndSerializeSubsequence
parameter_list|()
throws|throws
name|XMLDBException
block|{
...
name|query
init|=
literal|"let $query := \"for $i in (1 to 10) return<i>{$i}</i>\"\n"
operator|+
literal|"return\n"
operator|+
literal|"util:eval-and-serialize($query, (), 1, 4)"
decl_stmt|;
specifier|final
name|ResourceSet
name|result
...
name|assertEquals
argument_list|(
literal|"<i>1</i><i>2</i><i>3</i><i>4</i>"
argument_list|,
name|r
operator|.
name|getContent
