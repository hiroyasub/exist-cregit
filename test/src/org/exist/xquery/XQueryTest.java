...
specifier|public
name|void
name|importExternalClasspathModule
parameter_list|()
throws|throws
name|XMLDBException
block|{
...
name|setContent
argument_list|(
literal|"import module namespace ext1 = \"http://import-external-classpath-test.com\" at \"resource:org/exist/xquery/external-classpath-module.xqm\";\n"
operator|+
literal|"ext1:echo("
operator|+
name|timestamp
