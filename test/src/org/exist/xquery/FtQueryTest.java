...
name|MATCH_COUNT
init|=
literal|"<doc> term term<level1>term term</level1><level1>term</level1></doc>"
decl_stmt|;
specifier|private
specifier|final
specifier|static
...
argument_list|)
decl_stmt|;
comment|//	        service.removeCollection(TEST_COLLECTION_NAME);
comment|//            service.removeCollection("/db/system/config/db");
name|DatabaseManager
operator|.
