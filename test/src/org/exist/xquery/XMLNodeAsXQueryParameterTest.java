...
return|;
block|}
comment|/** 	 * Retrieves the base collection and thereof returns a reference to the collection's 	 * xquery service. 	 * 	 * @return the xquery service 	 * @throws XMLDBException on database error 	 */
specifier|private
specifier|final
name|XQueryService
name|getXQueryService
