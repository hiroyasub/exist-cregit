...
operator|)
decl_stmt|;
comment|//check for 'error' element
name|NodeList
name|errors
init|=
name|el
...
name|assertTrue
argument_list|(
literal|"not implemented 'assert-deep-eq'"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"not implemented 'assert-permutation'"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"not implemented 'assert-count'"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"not implemented 'assert-empty'"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|IOException
block|{
comment|//		res = res.replaceAll("\n", "");
comment|//		res = res.replaceAll("\t", "");
comment|//		expResult = expResult.replaceAll("\n", "");
comment|//		expResult = expResult.replaceAll("\t", "");
comment|//		System.out.println(expResult);
