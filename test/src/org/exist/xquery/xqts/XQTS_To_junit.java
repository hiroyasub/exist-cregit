...
literal|".xsd"
argument_list|)
comment|//                || file.getName().equals("badxml.xml")
comment|//                || file.getName().equals("BCisInvalid.xml")
comment|//                || file.getName().equals("InvalidUmlaut.xml")
comment|//                || file.getName().equals("InvalidXMLId.xml")
comment|//                || file.getName().equals("invalid-xml.xml")
condition|)
return|return;
if|if
condition|(
