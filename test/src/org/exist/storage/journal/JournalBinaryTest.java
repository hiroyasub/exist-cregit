...
argument_list|)
argument_list|,
comment|//                ReplaceBinary(replacedTxnId, replacedDbPath),
name|RenameBinary
argument_list|(
name|replacedTxnId
argument_list|,
...
block|}
block|}
comment|//    private class ExpectedDeleteBinary extends ExpectedLoggable {
comment|//        private final String deletedDbFile;
comment|//        private final Path dataDir;
comment|//
comment|//        public ExpectedDeleteBinary(final long transactionId, final String deletedDbFile) {
comment|//            super(transactionId);
comment|//            this.deletedDbFile = deletedDbFile;
comment|//            this.dataDir = (Path)existEmbeddedServer.getBrokerPool().getConfiguration().getProperty(BrokerPool.PROPERTY_DATA_DIR);
comment|//        }
comment|//
comment|//        @Override
comment|//        public boolean equals(final Object o) {
comment|//            if (this == o) return true;
comment|//            if (o == null || o.getClass() != DeleteBinaryLoggable.class) return false;
comment|//
comment|//            final Path deletedFile = dataDir.resolve(FS_SUBDIR + deletedDbFile);
comment|//
comment|//            final DeleteBinaryLoggable that = (DeleteBinaryLoggable) o;
comment|//            return that.transactionId == transactionId
comment|//&& that.getDeletedFile().equals(deletedFile);
comment|//        }
comment|//
comment|//        public String toString() {
comment|//            return "CREATE BINARY T-" + transactionId + " v=null" + " w=" + dataDir.resolve(FS_SUBDIR).resolve(deletedDbFile);
comment|//        }
comment|//    }
block|}
end_class
