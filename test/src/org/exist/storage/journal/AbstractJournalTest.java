...
return|;
block|}
comment|/**      * Store a document into the database.      *      * @param commitAndClose true if the transaction should be committed. false will leave the transaction      *      unfinished (i.e. neither committed, aborted, or closed)      * @param file The file containing the data to store in the document      * @param dbFilename the name to use when storing the file in the database      *      * @return a Tuple2(id, path), where id is of the transaction which stored the document, and path      *     is the path to the document in the database.      */
specifier|protected
name|Tuple2
argument_list|<
name|Long
