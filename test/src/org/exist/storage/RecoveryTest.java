...
parameter_list|()
block|{
comment|// restore the flag in-case of a test failure
name|BrokerPool
operator|.
...
specifier|public
name|void
name|storeCommit_removeNoCommit
parameter_list|()
throws|throws
name|PermissionDeniedException
throws|,
...
argument_list|)
expr_stmt|;
comment|// restart with no Journal checkpoint, forces recovery to run at startup
name|BrokerPool
operator|.
name|FORCE_CORRUPTION
operator|=
...
literal|false
expr_stmt|;
comment|// check the documents we stored exist
name|verify
argument_list|(
name|existEmbeddedServer
operator|.
