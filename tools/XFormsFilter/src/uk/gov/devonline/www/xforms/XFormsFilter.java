...
name|XFORMS_NS
init|=
literal|"http://www.w3.org/2002/xforms"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
argument_list|()
decl_stmt|;
comment|//find the xforms namespace local name
name|int
name|xfNSDeclEnd
init|=
name|strResponse
...
argument_list|)
decl_stmt|;
comment|//check for xforms model and instance elements
if|if
condition|(
name|strResponse
operator|.
