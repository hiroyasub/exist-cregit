...
name|child
decl_stmt|;
comment|/** 	 * Constructor for Append. 	 * 	 * @param broker the database broker. 	 * @param docs the document working set. 	 * @param selectStmt the select statement. 	 * @param childAttr the child attribute. 	 * @param namespaces the namespaces. 	 * @param variables the variables. 	 */
specifier|public
name|Append
parameter_list|(
name|DBBroker
