...
expr_stmt|;
block|}
comment|/** 	 * Authenticate the user by prompting for a user name and password. 	 *  	 * 	 *  	 * @return true in all cases since this<code>LoginModule</code> should not 	 *         be ignored. 	 *  	 * @throws FailedLoginException 	 *                if the authentication fails. 	 * 	 *  	 * @throws LoginException 	 *                if this<code>LoginModule</code> is unable to perform the 	 *                authentication. 	 */
specifier|public
name|boolean
name|login
parameter_list|()
...
return|;
block|}
comment|/** 	 * Logout the user. 	 *  	 * 	 * This method removes the<code>SamplePrincipal</code> that was added by 	 * the<code>commit</code> method. 	 *  	 * 	 *  	 * @throws LoginException 	 *                if the logout fails. 	 *  	 * @return true in all cases since this<code>LoginModule</code> should not 	 *         be ignored. 	 */
specifier|public
name|boolean
name|logout
parameter_list|()
