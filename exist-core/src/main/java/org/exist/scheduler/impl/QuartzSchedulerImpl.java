...
parameter_list|()
block|{
comment|//try and load the properties for quartz from eXist-db's conf directory
name|Path
name|f
init|=
name|ConfigurationHelper
...
name|info
argument_list|(
literal|"Successfully loaded Quartz Scheduler properties from: "
operator|+
name|f
operator|.
name|normalize
...
name|warn
argument_list|(
literal|"Could not load Quartz Scheduler properties, will use defaults. "
operator|+
name|e
operator|.
name|getMessage
