...
parameter_list|()
function_decl|;
comment|/** 	 * Starts or resumes the script until a new breakpoint is reached, or the end of the script is reached. 	 * @param listener to be documented 	 */
specifier|public
name|void
name|run
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/** 	 * Steps to the next statement, if there is a function call involved it will break on the first statement in that function 	 * @param listener to be documented 	 */
specifier|public
name|void
name|stepInto
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/** 	 * Steps to the next statement, if there is a function call on the line from which the step_over is issued then the debugger engine will stop at the statement after the function call in the same scope as from where the command was issued 	 * @param listener to be documented 	 */
specifier|public
name|void
name|stepOver
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/** 	 * Steps out of the current scope and breaks on the statement after returning from the current function. (Also called 'finish' in GDB) 	 * @param listener to be documented 	 */
specifier|public
name|void
name|stepOut
parameter_list|(
