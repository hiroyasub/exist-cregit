...
name|this
operator|::
name|cbmiPrimaryGroupActionPerformed
argument_list|)
expr_stmt|;
name|pmMemberOfGroups
operator|.
...
argument_list|(
name|getMemberOfGroupsListCellRenderer
argument_list|()
argument_list|)
expr_stmt|;
name|lstMemberOfGroups
...
parameter_list|)
block|{
name|lstMemberOfGroupsMouseClicked
argument_list|(
name|evt
argument_list|)
expr_stmt|;
...
parameter_list|()
block|{
comment|//0 - determine the primary group
specifier|final
name|GroupAider
name|primaryGroup
decl_stmt|;
...
name|this
argument_list|,
literal|"Could not determine primary group for user '"
operator|+
name|txtUsername
operator|.
name|getText
argument_list|()
operator|+
literal|"'. User must create personal group or belong to at least one existing group"
argument_list|,
...
name|this
argument_list|,
literal|"Could not set primary group '"
operator|+
name|getPrimaryGroup
argument_list|()
operator|+
...
argument_list|)
expr_stmt|;
comment|//is this the first group added to the user?
if|if
condition|(
name|getMemberOfGroupsListModel
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//are we removing the users primary group?
if|if
condition|(
name|group
operator|.
...
block|{
comment|//default to the first group
specifier|final
name|String
name|firstGroup
init|=
...
parameter_list|)
block|{
comment|//GEN-FIRST:event_cbmiPrimaryGroupActionPerformed
specifier|final
name|String
name|newPrimaryGroup
init|=
operator|(
name|String
operator|)
...
condition|)
block|{
comment|// deselect existing primary group
name|this
operator|.
name|primaryGroup
operator|=
...
block|{
comment|// select new primary group
name|this
operator|.
name|primaryGroup
operator|=
...
expr_stmt|;
block|}
comment|//GEN-LAST:event_cbmiPrimaryGroupActionPerformed
specifier|private
name|void
name|lstMemberOfGroupsMouseClicked
parameter_list|(
...
parameter_list|)
block|{
comment|//GEN-FIRST:event_lstMemberOfGroupsMouseClicked
name|cbmiPrimaryGroup
operator|.
name|setState
argument_list|(
...
expr_stmt|;
block|}
comment|//GEN-LAST:event_lstMemberOfGroupsMouseClicked
specifier|private
name|boolean
name|isValidUserDetails
parameter_list|()
