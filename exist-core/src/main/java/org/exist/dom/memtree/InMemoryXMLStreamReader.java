...
return|;
block|}
comment|/**      * Allows access to namespaces that are in-scope      * by using a reference counting mechanism as      * opposed to a stack.      */
specifier|private
specifier|static
class|class
name|InScopeNamespaces
...
expr_stmt|;
block|}
comment|/**          * Push an in-scope namespace.          *          * The namespace.          */
specifier|public
name|void
name|push
parameter_list|(
...
expr_stmt|;
block|}
comment|/**          * Pop an in-scope namespace.          */
specifier|public
name|void
name|pop
parameter_list|(
