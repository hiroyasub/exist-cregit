...
literal|0
decl_stmt|;
comment|/**      * Create a FastStringBuffer with a given initial capacity      * @param initialSize the initial capacity      */
specifier|public
name|FastStringBuffer
parameter_list|(
name|int
...
name|SUPPRESS_TRAILING_WS
decl_stmt|;
comment|/**      *  Gets the normalizedString attribute of the FastStringBuffer object      *      *@param  mode  Trim mode      *@return       The normalizedString value      */
specifier|public
name|String
