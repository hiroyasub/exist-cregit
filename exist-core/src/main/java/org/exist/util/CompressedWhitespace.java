...
block|}
block|}
comment|/**      * Write the value to a Writer with escaping of special characters.      *      * @param specialChars an array of special character markers      * @param writer the writer      *      * @throws java.io.IOException if an error occurs whilst writing      */
specifier|public
name|void
name|writeEscape
parameter_list|(
