...
literal|""
decl_stmt|;
comment|/**      * When serializing an XDM this should be true,      * otherwise false.      *      * XDM has different serialization rules      * compared to retrieving resources from the database.      */
specifier|private
name|boolean
name|xdmSerialization
init|=
literal|false
decl_stmt|;
specifier|private
...
name|this
operator|::
name|parseCdataSectionElementNames
argument_list|)
decl_stmt|;
specifier|private
name|boolean
name|cdataSetionElement
init|=
literal|false
decl_stmt|;
static|static
