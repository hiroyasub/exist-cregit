...
return|;
block|}
comment|/**      * @return null if we could not perform an optimistic read, or a new object needed to be      *     created and we could not take the {@link #stripesLock} write lock immediately.      */
specifier|private
annotation|@
name|Nullable
name|WeakValueReference
...
return|;
block|}
comment|/**      * @return null if a new object needed to be created and we could not take the {@link #stripesLock}      *     write lock immediately.      */
specifier|private
annotation|@
name|Nullable
name|WeakValueReference
