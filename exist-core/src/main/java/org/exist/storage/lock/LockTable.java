...
argument_list|)
expr_stmt|;
comment|// release the key in the map
name|THREADLOCAL_ENTRY_KEY_POOL
operator|.
name|get
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// release the value in the map
name|THREADLOCAL_ENTRY_POOL
operator|.
name|get
argument_list|()
...
name|error
argument_list|(
literal|"No entry found when trying to remove acquired attempt for: id={}"
operator|+
name|id
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"No entry found when trying to release for: id={}"
operator|+
name|id
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Unable to remove entry for: id={}"
operator|+
name|id
argument_list|)
expr_stmt|;
