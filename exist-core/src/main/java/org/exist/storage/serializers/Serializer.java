...
specifier|static
name|QName
name|ATTR_COMPILATION_TIME_QNAME
init|=
operator|new
name|QName
argument_list|(
...
specifier|static
name|QName
name|ATTR_EXECUTION_TIME_QNAME
init|=
operator|new
name|QName
argument_list|(
...
expr_stmt|;
block|}
comment|/** 	 * Serializes an Item 	 * 	 * @param item The item to serialize 	 * @param wrap Indicates whether the output should be wrapped 	 * @param typed Indicates whether the output types should be wrapped 	 * 	 * @throws SAXException If an error occurs during serialization 	 */
specifier|public
name|void
name|toSAX
parameter_list|(
