...
return|;
block|}
comment|/**      * Store a raw binary resource into the file. The data will always be      * written into an overflow page.      *      * @param transaction the transaction      * @param doc the document to add      * @param is Binary resource as stream.      *      * @return the page num      */
specifier|public
name|long
name|addBinary
parameter_list|(
