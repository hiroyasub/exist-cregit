...
return|;
block|}
comment|/**      * Find the journal file with the highest file number.      *      * @param files the journal files to consider.      * @return the journal file with the highest file number      */
specifier|public
specifier|static
name|int
name|findLastFile
...
return|;
block|}
comment|/**      * Returns the file corresponding to the specified      * file number.      *      * @param fileNum the journal file number.      * @return the file corresponding to the specified file number.      */
specifier|public
name|Path
name|getFile
parameter_list|(
