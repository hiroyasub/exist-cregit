...
expr_stmt|;
block|}
comment|/**      * Create a new loggable for the given type.      *      * @param broker The broker that will perform the operation      * @param type The type of the loggable      * @param broker the database broker      * @param transactionId the id of the current transaction      *      * @return The loggable for the type, or null if no loggable for the type is known      *      * @throws LogException if the entry could not be created      */
specifier|public
specifier|final
specifier|static
name|Loggable
