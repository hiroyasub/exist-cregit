...
begin_comment
comment|/**      * Get a static decimal format.      *      * @param qnDecimalFormat the name of the decimal format, or null for the UNNAMED format.      *      * @return the decimal format, or null if there is no format matching the name      */
end_comment
...
begin_comment
comment|/**      * Set a static decimal format.      *      * @param qnDecimalFormat the name of the decimal format      * @param decimalFormat the decimal format      */
end_comment

begin_function
specifier|public
name|void
name|setStaticDecimalFormat
parameter_list|(
specifier|final
name|QName
name|qnDecimalFormat
