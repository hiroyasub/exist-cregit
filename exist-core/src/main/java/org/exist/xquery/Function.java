...
expr_stmt|;
block|}
comment|/**      * Check the function arguments.      *      * @param argument the argument      * @param argType the type of the argument if known, or null      * @param argContextInfo the context info from analyzing the argument      * @param argPosition the position of the argument      *      * @throws XPathException if an error occurs when checking the arguments.      */
specifier|protected
name|void
name|checkArgument
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Statically check an argument against the sequence type specified in      * the signature.      *      * @param argument the argument      * @param argType the type of the argument if known, or null      * @param argContextInfo the context info from analyzing the argument      * @param argPosition the position of the argument      *      * @return The passed expression      *      * @throws XPathException if an error occurs whilst checking the argument      */
specifier|private
name|Expression
name|checkArgumentType
parameter_list|(
...
init|=
name|checkArgumentTypeCardinality
argument_list|(
name|argument
argument_list|,
name|argType
...
name|Integer
argument_list|>
name|looseCheckResult
init|=
name|looseCheckArgumentType
argument_list|(
name|argument
argument_list|,
name|argType
...
name|Integer
argument_list|>
name|strictCheckResult
init|=
name|strictCheckArgumentType
argument_list|(
name|argument
argument_list|,
name|argType
