...
condition|)
block|{
comment|// for a positional predicate, check if it depends on the context item
comment|// if not, do not pass the context sequence to avoid cardinality errors
name|context
operator|.
...
name|FORG0006
argument_list|,
literal|"Effective boolean value is not defined for a sequence of two or more items starting with a "
operator|+
name|Type
operator|.
name|getTypeName
