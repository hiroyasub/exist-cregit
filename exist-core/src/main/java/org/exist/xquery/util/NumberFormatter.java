...
literal|'#'
decl_stmt|;
comment|/**      * Get the zero digit corresponding to the digit family of the given value.      * This method was taken from saxon, see<a href="http://saxon.sourceforge.net/">http://saxon.sourceforge.net/</a>.      *      */
specifier|public
specifier|static
name|int
name|getZeroDigit
