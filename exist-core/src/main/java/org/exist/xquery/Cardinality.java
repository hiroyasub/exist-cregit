...
block|}
block|}
comment|/**      * Get the Cardinality from an integer representation.      *      * @param intValue integer representation of cardinality      *      * @return the cardinality      *      * @deprecated You should not pass cardinality as integer values,      *     this is for backwards compatibility with eXist-db      */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
name|IllegalArgumentException
argument_list|(
literal|"No know cardinality for intValue: "
operator|+
name|intValue
argument_list|)
throw|;
