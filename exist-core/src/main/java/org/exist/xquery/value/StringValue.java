...
return|;
block|}
comment|/**      * The method<code>expandEntity</code>      *      * @param buf a<code>String</code> value      * @return an<code>int</code> value      * @throws XPathException if an error occurs      */
specifier|private
specifier|final
specifier|static
name|int
...
block|}
block|}
comment|/**      * The method<code>expandCharRef</code>      *      * @param buf a<code>String</code> value      * @return an<code>int</code> value      * @throws XPathException if an error occurs      */
specifier|private
specifier|final
specifier|static
name|int
