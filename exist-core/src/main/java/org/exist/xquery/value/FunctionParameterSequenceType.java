...
expr_stmt|;
block|}
comment|/**      * @param attributeName The name of the parameter in the<strong>FunctionSignature</strong>.      * @param primaryType   The<strong>Type</strong> of the parameter.      * @param cardinality   The<strong>Cardinality</strong> of the parameter.      * @param description   A description of the parameter in the<strong>FunctionSignature</strong>.      * @see org.exist.xquery.FunctionSignature @see Type @see org.exist.xquery.Cardinality      *      * @deprecated Use {@link #FunctionParameterSequenceType(String, int, Cardinality, String)}      */
annotation|@
name|Deprecated
specifier|public
name|FunctionParameterSequenceType
