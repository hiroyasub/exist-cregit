...
expr_stmt|;
block|}
comment|/**      * Construct a new SequenceType using the specified      * primary type and cardinality.      *      * @param primaryType one of the constants defined in {@link Type}      * @param cardinality the cardinality integer value      *                          * @deprecated Use {@link #SequenceType(int, Cardinality)}      */
annotation|@
name|Deprecated
specifier|public
name|SequenceType
...
block|{
comment|// get the name of the element/attribute
name|realName
operator|=
name|nvItem
operator|.
