...
argument_list|)
expr_stmt|;
comment|//defineSubType(ITEM, NODE);                // TODO(AR) this appears in the XDM 3.1, but uncommenting this breaks a lot of stuff in eXist-db
comment|// ATOMIC sub-types
name|defineSubType
argument_list|(
name|ATOMIC
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// DATE_TIME sub-types
comment|//defineSubType(DATE_TIME, DATE_TIME_STAMP);
comment|// DURATION sub-types
name|defineSubType
argument_list|(
name|DURATION
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// NON_NEGATIVE_INTEGER sub-types
name|defineSubType
argument_list|(
name|NON_NEGATIVE_INTEGER
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// UNSIGNED_LONG sub-types
name|defineSubType
argument_list|(
name|UNSIGNED_LONG
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// UNSIGNED_INT sub-types
name|defineSubType
argument_list|(
name|UNSIGNED_INT
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// UNSIGNED_SHORT sub-types
name|defineSubType
argument_list|(
name|UNSIGNED_SHORT
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// NON_POSITIVE_INTEGER sub-types
name|defineSubType
argument_list|(
name|NON_POSITIVE_INTEGER
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// NORMALIZED_STRING sub-types
name|defineSubType
argument_list|(
name|NORMALIZED_STRING
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// FUNCTION_REFERENCE sub-types
name|defineSubType
argument_list|(
name|FUNCTION_REFERENCE
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// TODO(AR) this doesn't appear in the XDM 3.1
name|defineSubType
argument_list|(
name|NODE
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// keep `xdt:anyAtomicType` for backward compatibility
name|defineBuiltInType
argument_list|(
name|UNTYPED_ATOMIC
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// keep `xdt:untypedAtomic` for backward compatibility
name|defineBuiltInType
argument_list|(
name|BOOLEAN
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// keep `xdt:yearMonthDuration` for backward compatibility
name|defineBuiltInType
argument_list|(
name|DAY_TIME_DURATION
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// keep `xdt:dayTimeDuration` for backward compatibility
name|defineBuiltInType
argument_list|(
name|NORMALIZED_STRING
argument_list|,
...
expr_stmt|;
block|}
comment|// https://www.w3.org/TR/xmlschema-2/#built-in-primitive-datatypes
static|static
block|{
name|definePrimitiveType
argument_list|(
name|STRING
argument_list|,
operator|new
...
expr_stmt|;
block|}
comment|/**      * Define a primitive type.      *      * @param primitiveType the primitive type      * @param subTypes the subtypes of the primitive type      */
specifier|private
specifier|static
name|void
name|definePrimitiveType
...
expr_stmt|;
block|}
comment|// primitive type of a primitive type is itself!
name|primitiveTypes
operator|.
name|put
argument_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"Primitive type is not defined for: "
operator|+
operator|(
name|typeName
operator|!=
