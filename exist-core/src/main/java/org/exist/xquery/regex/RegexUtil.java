...
return|;
block|}
comment|/**      * Translates the Regular Expression from XPath3 syntax to Java regex      * syntax.      *      * @param pattern a String containing a regular expression in the syntax of XPath F&O 3.0.      * @param ignoreWhitespace true if whitespace is to be ignored ('x' flag)      * @param caseBlind true if case is to be ignored ('i' flag)      *      * @return The Java Regular Expression      *      * @throws XPathException if the XQuery Regular Expression is invalid.      */
specifier|public
specifier|static
name|String
