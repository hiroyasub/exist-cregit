...
argument_list|)
expr_stmt|;
comment|// parent may have been modified by testExpr: set it again
name|myContextInfo
operator|.
name|setParent
argument_list|(
...
block|}
block|}
comment|/* (non-Javadoc)      * @see org.exist.xquery.Expression#preselect(org.exist.dom.persistent.DocumentSet)      */
specifier|public
name|DocumentSet
name|preselect
parameter_list|(
