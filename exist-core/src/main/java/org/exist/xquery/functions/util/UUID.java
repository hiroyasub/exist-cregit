...
argument_list|)
argument_list|,
literal|"Generate a version 3 universally unique identifier (UUID) string, e.g. 2b92ddb6-8e4e-3891-b519-afa1609ced73"
argument_list|,
operator|new
name|SequenceType
index|[]
...
name|EXACTLY_ONE
argument_list|,
literal|"The input value for UUID calculation."
argument_list|)
block|,                     }
argument_list|,
operator|new
