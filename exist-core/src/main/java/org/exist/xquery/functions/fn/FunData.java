...
argument_list|)
argument_list|,
literal|"Atomizes the context item, replacing all nodes in the sequence by their typed values."
argument_list|,
operator|new
name|SequenceType
index|[
...
argument_list|)
argument_list|,
literal|"Atomizes the sequence $items, replacing all nodes in the sequence by their typed values."
argument_list|,
operator|new
name|SequenceType
index|[]
