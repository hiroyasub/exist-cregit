...
operator|+
literal|"$util:exception-message will be bound to the message produced by the exception, "
operator|+
literal|"and $util:error-code will be bound to the xs:QName error code."
argument_list|,
operator|new
name|SequenceType
index|[]
...
try|try
block|{
comment|// Get value of exception argument
specifier|final
name|String
name|exClassName
init|=
