...
name|XMLDBException
block|{
comment|/*          * Create the collections:          *          * /db/testMove/0          * /db/testMove/1          * /db/testMove/0/X          * /db/testMove/0/X/Y          */
...
argument_list|)
expr_stmt|;
comment|// move the collection /db/testMove/0/X to /db/testMove/1
name|service
operator|=
operator|(
name|EXistCollectionManagementService
