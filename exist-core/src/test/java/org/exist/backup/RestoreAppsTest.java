...
expr_stmt|;
block|}
comment|/**      * Create a library package and generate a backup. Install a newer version      * of the same package and restore the backup. The newer version inside      * the expath repo should be preserved and not overwritten.      *      * Library packages are restored into /db/system/repo, not /db/apps, therefore      * we need an extra test.      *      * @throws Exception in case of error      */
annotation|@
name|Test
specifier|public
name|void
name|restoreSkipNewerLib
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Semver coercion: create an app with an incomplete semver and try to restore it. The newer version inside      * the expath repo should be preserved and not overwritten.      *      * @throws Exception in case of error      */
annotation|@
name|Test
specifier|public
name|void
name|restoreWithIncompleteSemverAndSkipNewer
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Create a library package and generate a backup. Install an older version      * of the same package and restore the backup. The newer version inside      * the backup should overwrite the older in the database.      *      * Library packages are restored into /db/system/repo, not /db/apps, therefore      * we need an extra test.      *      * @throws Exception in case of error      */
annotation|@
name|Test
specifier|public
name|void
name|restoreOverwriteOlderLib
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Semver coercion: create an app with an incomplete semver and try to restore it.      * The newer version inside the backup should overwrite the older in the database.      *      * @throws Exception in case of error      */
annotation|@
name|Test
specifier|public
name|void
name|restoreOverwriteOlderWithIncompleteSemver
parameter_list|()
throws|throws
name|Exception
block|{
