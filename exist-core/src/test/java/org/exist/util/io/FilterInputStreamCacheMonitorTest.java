...
name|warn
argument_list|(
literal|"FilterInputStreamCacheMonitor should have no active binaries, but found: "
operator|+
name|activeCount
operator|+
literal|"."
...
argument_list|()
operator|+
literal|"It is likely that a previous test or process within the same JVM is leaking file handles! This should be investigated..."
argument_list|)
expr_stmt|;
block|}
name|monitor
...
name|fail
argument_list|(
literal|"FilterInputStreamCacheMonitor should again have no active binaries, but found: "
operator|+
name|activeCount
operator|+
literal|"."
