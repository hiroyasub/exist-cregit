...
begin_comment
comment|/**  * Tests for the validation:jing() function with RNGs and RNCs.  *   * @author dizzzz@exist-db.org  */
end_comment
...
block|,
literal|"personal.rng"
block|,
literal|"personal.rnc"
block|}
decl_stmt|;
annotation|@
name|ClassRule
...
operator|+
literal|"doc('/db/personal/personal.rng') )"
decl_stmt|;
specifier|final
name|ResourceSet
name|results
...
name|query
init|=
literal|"validation:jing-report( xs:anyURI('xmldb:exist:///db/personal/personal-valid.xml'), "
operator|+
...
name|query
init|=
literal|"validation:jing-report( xs:anyURI('xmldb:exist:///db/personal/personal-invalid.xml'), "
operator|+
literal|"xs:anyURI('xmldb:exist:///db/personal/personal.rnc') )"
decl_stmt|;
name|executeAndEvaluate
