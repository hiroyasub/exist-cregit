...
specifier|public
name|void
name|checkGroupManagerStability
parameter_list|()
throws|throws
name|XMLDBException
throws|,
...
argument_list|)
decl_stmt|;
comment|//set users primary group as personal group
try|try
block|{
comment|// create a user with personal group
name|ums
operator|.
name|addGroup
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//add user1 as a manager of common group
name|ums
operator|.
name|addGroup
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// assert that user1 is still a manager of the common group
specifier|final
name|List
argument_list|<
name|Account
argument_list|>
name|commonGroupManagers
init|=
name|commonGroup
operator|.
name|getManagers
