...
name|getSample
argument_list|(
literal|"validation/addressbook/catalog.xml"
argument_list|)
init|)
block|{
name|TestTools
...
name|getSample
argument_list|(
literal|"validation/addressbook/addressbook_valid.xml"
argument_list|)
init|)
block|{
name|TestTools
...
name|getSample
argument_list|(
literal|"validation/addressbook/addressbook_invalid.xml"
argument_list|)
init|)
block|{
name|TestTools
...
name|getSample
argument_list|(
literal|"validation/dtd/hamlet_wrongdoctype.xml"
argument_list|)
init|)
block|{
name|TestTools
