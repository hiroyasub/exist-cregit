...
begin_comment
comment|/**  * an ant task to shutdown a XMLDB database.  *  * @author  Wolfgang Meier (wolfgang@exist-db.org)  *  *          slightly modified by:  * @author  peter.klotz@blue-elephant-systems.com  */
end_comment
