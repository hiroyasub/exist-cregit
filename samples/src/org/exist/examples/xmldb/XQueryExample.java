...
begin_comment
comment|/**  *  Reads an XQuery file and executes it. To run this example enter:   *   *  bin/run.sh examples.xmldb.XQueryExample<xqueryfile>  *    *  in the root directory of the distribution.  *  *@author     Wolfgang Meier<meier@ifs.tu-darmstadt.de>  *@created    20. September 2002  */
end_comment
