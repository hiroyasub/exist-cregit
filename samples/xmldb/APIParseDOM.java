...
begin_comment
comment|/**  * Add a document to the repository.  *  * To run this example enter:  *  * bin/run.sh samples.APIParse [ collection ] fileName  *  * in the root directory of the distribution.  */
end_comment
...
name|println
argument_list|(
literal|"usage: samples.APIParse collection docName"
argument_list|)
expr_stmt|;
name|System
operator|.
