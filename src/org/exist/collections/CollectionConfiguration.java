...
name|List
argument_list|>
name|getTriggerParameterChildParameters
parameter_list|(
name|Element
name|param
parameter_list|)
...
return|;
comment|//            try {
comment|//                Trigger trigger = clazz.newInstance();
comment|//                trigger.configure(broker, collection, parameters);
comment|//                return trigger;
...
name|CollectionTrigger
argument_list|>
name|getCollectionTriggerClass
parameter_list|()
block|{
return|return
name|collectionTriggersClazz
