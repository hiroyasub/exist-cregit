...
return|;
block|}
comment|/**      * Verify that the owner of the document is DBA, the document is owned by the DBA group and that the permissions are      * set 0770, and the mimetype is set application/xquery.      *      * @param document The document      * @return TRUE if the conditions are met, else FALSE      */
specifier|private
name|boolean
name|isPermissionsOK
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Set ownership and mode
name|PermissionFactory
operator|.
name|chown
argument_list|(
