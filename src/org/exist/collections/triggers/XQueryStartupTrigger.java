...
begin_comment
comment|/**  * Startup Trigger to fire XQuery scripts during database startup.  *  * Either load scripts into /db/system/autostart or add to conf.xml :  *  *<pre>  * {@code  *<startup>  *<triggers>  *<trigger class="org.exist.collections.triggers.XQueryStartupTrigger">  *<parameter name="xquery" value="/db/script1.xq"/>  *<parameter name="xquery" value="/db/script2.xq"/>  *</trigger>  *</triggers>  *</startup>  * }  *</pre>  *  * @author Dannes Wessels  */
end_comment
