...
parameter_list|)
block|{
comment|//TODO this should not be caught - it should be thrown - lock errors are bad!!!
name|LOG
operator|.
name|error
argument_list|(
...
block|}
block|}
comment|/**      * Determines if this Collection has any documents, or sub-collections      */
specifier|public
name|boolean
name|isEmpty
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|//TODO what is this number 19?
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
comment|/**      * Check Permissions about user and document when a document is added to the databse, and throw exceptions if necessary.      *      * @param broker      * @param oldDoc old Document existing in database prior to adding a new one with same name, or null if none exists      * @throws LockException      * @throws PermissionDeniedException      */
specifier|private
name|void
name|checkPermissionsForAddDocument
parameter_list|(
