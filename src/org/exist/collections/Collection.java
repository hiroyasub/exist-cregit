...
name|PermissionDeniedException
function_decl|;
comment|/**      * Add a new child Collection to this Collection      *      * @param broker The database broker      * @param child  The child Collection to add to this Collection      * @param isNew  Whether the Child Collection is a newly created Collection      */
name|void
name|addCollection
parameter_list|(
name|DBBroker
