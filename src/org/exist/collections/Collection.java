...
block|}
block|}
comment|/**      * Gets a stable set of the the document object      * names from {@link #documents}      */
specifier|private
name|Set
argument_list|<
name|String
...
block|}
block|}
comment|/**      * @deprecated Use {@link #getDocumentCount(DBBroker)}      */
annotation|@
name|Deprecated
specifier|public
name|int
...
expr_stmt|;
block|}
comment|/** Update the modification time of a document      * @param document      */
specifier|private
name|void
name|updateModificationTime
parameter_list|(
