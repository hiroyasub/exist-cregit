...
expr_stmt|;
block|}
comment|/** 	 * Adds a document to the collection, but doesn't keep the document 	 * object in memory. The collection will be reloaded the first time the 	 * new document is accessed. Using this method helps to keep memory 	 * consumption low when loading many documents in a batch. 	 *  	 * @param broker 	 * @param doc 	 */
specifier|public
name|void
...
return|;
block|}
comment|/** 	 * @param broker 	 * @param name 	 * @param document 	 * @param oldDoc 	 * @param reader 	 * @param source 	 * @return 	 * @throws LockException 	 * @throws EXistException 	 * @throws SAXException 	 * @throws PermissionDeniedException 	 * @throws TriggerException 	 */
specifier|private
name|IndexInfo
name|determineTreeStructure
parameter_list|(
...
block|}
block|}
comment|/** prepare the SAX parser 	 * @param broker 	 * @param name 	 * @param oldDoc 	 * @param trigger 	 * @param indexer 	 * @param reader the real source of the XML data 	 * @throws EXistException 	 * @throws SAXException 	 * @throws SAXNotRecognizedException 	 * @throws SAXNotSupportedException 	 * @throws TriggerException 	 */
specifier|private
name|void
name|prepareSAXParser
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// reader = getReader(broker);
name|reader
operator|.
...
expr_stmt|;
block|}
comment|//ffffffffffffffffffffffffffffffffffffffffffffffff
try|try
block|{
comment|// second pass: store the document
if|if
...
name|warn
argument_list|(
literal|"collection.xconf exists but could not be loaded"
argument_list|)
expr_stmt|;
return|return
literal|null
