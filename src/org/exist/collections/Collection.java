...
name|PermissionDeniedException
argument_list|(
comment|//"Write access to collection denied; user=" + broker.getUser().getName());
literal|"Write access to collection denied"
argument_list|)
throw|;
if|if
condition|(
...
name|PermissionDeniedException
argument_list|(
comment|//"User '" + broker.getUser().getName() + "' not allowed to write to collection '" + getURI() + "'");
