...
begin_comment
comment|/*  *  Collection.java - eXist Open Source Native XML Database  *  Copyright (C) 2001 Wolfgang M. Meier  *  wolfgang@exist-db.org  *  http://exist.sourceforge.net  *  *  This program is free software; you can redistribute it and/or  *  modify it under the terms of the GNU Lesser General Public License  *  as published by the Free Software Foundation; either version 2  *  of the License, or (at your option) any later version.  *  *  This program is distributed in the hope that it will be useful,  *  but WITHOUT ANY WARRANTY; without even the implied warranty of  *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the  *  GNU Lesser General Public License for more details.  *  *  You should have received a copy of the GNU Lesser General Public License  *  along with this program; if not, write to the Free Software  *  Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.  *   * $Id:  */
end_comment
...
decl_stmt|;
comment|// the broker instance that created this collection
specifier|private
name|DBBroker
name|broker
decl_stmt|;
...
expr_stmt|;
block|}
comment|/** 	 *  Add a document to the collection. 	 * 	 *@param  user 	 *@param  doc 	 */
specifier|synchronized
specifier|public
name|void
name|addDocument
...
return|;
block|}
comment|/** 	 * Returns the broker instance that created this collection. 	 *  	 * @return 	 */
specifier|protected
specifier|synchronized
name|DBBroker
name|getBroker
...
return|;
block|}
comment|//	public synchronized CollectionConfiguration getConfiguration()
comment|//	throws CollectionConfigurationException {
comment|//		if(configuration == null)
comment|//			configuration =
comment|//				new CollectionConfiguration(this, getDocument(COLLECTION_CONFIG_FILE));
...
expr_stmt|;
block|}
comment|/** 	 *  Set the id of this collection. 	 * 	 *@param  id  The new id value 	 */
specifier|public
name|void
name|setId
parameter_list|(
...
expr_stmt|;
block|}
comment|/** 	 *  Set the name of this collection. 	 * 	 *@param  name  The new name value 	 */
specifier|public
name|void
name|setName
parameter_list|(
...
expr_stmt|;
block|}
comment|/** 	 *  Set permissions for the collection. 	 * 	 *@param  mode  The new permissions value 	 */
specifier|public
specifier|synchronized
name|void
name|setPermissions
...
expr_stmt|;
block|}
comment|/** 	 *  Set permissions for the collection. 	 * 	 *@param  mode                 The new permissions value 	 *@exception  SyntaxException  Description of the Exception 	 */
specifier|public
specifier|synchronized
name|void
name|setPermissions
