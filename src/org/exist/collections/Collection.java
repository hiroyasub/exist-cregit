...
return|;
block|}
comment|/** prepare the SAX parser 	 * @param broker 	 * @param name 	 * @param oldDoc 	 * @param trigger 	 * @param indexer 	 * @return 	 * @throws EXistException 	 * @throws SAXException 	 * @throws SAXNotRecognizedException 	 * @throws SAXNotSupportedException 	 * @throws TriggerException 	 */
specifier|private
name|XMLReader
name|prepareSAXParser
parameter_list|(
...
block|}
block|}
comment|/** Check Permissions about user and document, and throw exceptions if necessary. 	 * @param broker 	 * @param name 	 * @return 	 * @throws LockException 	 * @throws PermissionDeniedException 	 */
specifier|private
name|DocumentImpl
name|checkPermissions
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|//ddddddddddddddddddddddddddddddd
name|document
operator|.
name|calculateTreeLevelStartPoints
argument_list|()
...
expr_stmt|;
block|}
comment|//ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
comment|// reset the input source
try|try
block|{
specifier|final
