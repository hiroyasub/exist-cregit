...
block|}
block|}
comment|//Try to promote a boolean evaluation to a positionnal one  (second case)
if|if
condition|(
name|executionMode
operator|==
...
parameter_list|)
block|{
comment|//Keep in boolean mode : How ugly !!!
comment|//innerExpressionDot is false for (1,2,3)[. lt 3]
block|}
block|}
if|if
...
condition|)
block|{
comment|//Can't do anything else...
comment|//TODO : pass this to selectByPosition() ?
name|Sequence
name|innerSeq
init|=
name|inner
...
argument_list|)
decl_stmt|;
comment|//TODO : ideally, we would like to order and avoid duplicates
name|positions
operator|.
name|addAll
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//Useless if ordered and if duplicates are removed
break|break;
block|}
block|}
block|}
