...
return|;
block|}
comment|/**      * Check every collection in the context sequence for an existing range index by QName.      *      * @param contextSequence      * @return the type of a usable index or {@link Type#ITEM} if there is no common      *  index.      */
specifier|private
name|int
name|getQNameIndexType
parameter_list|(
