...
name|this
argument_list|,
literal|"Returning cached result. Length: "
operator|+
name|cached
operator|.
name|getResult
...
argument_list|)
expr_stmt|;
comment|//TODO : find when this condition must return true !
comment|//It should for :
comment|//let $a := (<c id="1"><d id="2">d</d><e>e</e></c>)/descendant-or-self::node()
comment|//for $b in $a/attribute::id
comment|//return<b>{$b}</b>
comment|//Note that it also works with selector = null
if|if
condition|(
literal|false
condition|)
