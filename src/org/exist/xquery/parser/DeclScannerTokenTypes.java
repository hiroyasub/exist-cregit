...
literal|98
decl_stmt|;
comment|// "no-preserve" = 99
name|int
name|LITERAL_inherit
init|=
literal|100
decl_stmt|;
comment|// "no-inherit" = 101
name|int
name|DOLLAR
init|=
literal|102
...
literal|189
decl_stmt|;
comment|// "namespace-node" = 190
comment|// "processing-instruction" = 191
comment|// "document-node" = 192
name|int
...
literal|204
decl_stmt|;
comment|// "descendant-or-self" = 205
comment|// "following-sibling" = 206
name|int
name|LITERAL_parent
init|=
literal|207
...
literal|208
decl_stmt|;
comment|// "ancestor-or-self" = 209
comment|// "preceding-sibling" = 210
name|int
