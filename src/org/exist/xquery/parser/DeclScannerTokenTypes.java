...
begin_comment
comment|// $ANTLR 2.7.4: "DeclScanner.g" -> "DeclScanner.java"$
end_comment
...
literal|84
decl_stmt|;
comment|// "no-preserve" = 85
name|int
name|LITERAL_inherit
init|=
literal|86
decl_stmt|;
comment|// "no-inherit" = 87
name|int
name|DOLLAR
init|=
literal|88
...
literal|166
decl_stmt|;
comment|// "processing-instruction" = 167
comment|// "document-node" = 168
name|int
...
literal|179
decl_stmt|;
comment|// "descendant-or-self" = 180
comment|// "following-sibling" = 181
name|int
name|LITERAL_parent
init|=
literal|182
...
literal|183
decl_stmt|;
comment|// "ancestor-or-self" = 184
comment|// "preceding-sibling" = 185
name|int
name|DOUBLE_LITERAL
init|=
literal|186
