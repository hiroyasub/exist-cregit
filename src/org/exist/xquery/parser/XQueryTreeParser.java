...
argument_list|()
decl_stmt|;
comment|//TODO add in handling for %private and %public in the fn namespace
if|if
condition|(
name|ns
operator|.
...
operator|.
name|XQueryAST
name|dynamicFunctionCall_AST_in
init|=
operator|(
name|_t
operator|==
...
init|=
block|{
literal|140814797766656L
block|,
literal|37383397965824L
block|,
literal|66428094503714816L
block|,
literal|0L
block|,
literal|0L
