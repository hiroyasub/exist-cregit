...
argument_list|()
expr_stmt|;
comment|// attach group by to last for expression, skipping lets
name|ForLetClause
name|clause
init|=
literal|null
...
argument_list|()
decl_stmt|;
comment|// if there is no groupSpec expression, try to find definition of
comment|// grouping variable and inline it
if|if
condition|(
name|groupSpecExpr
operator|==
...
name|XPathException
argument_list|(
literal|"Definition for grouping var "
operator|+
name|groupKeyVar
operator|+
literal|" not found"
...
throw|;
block|}
comment|// inline the grouping expression
name|clauses
operator|.
name|remove
argument_list|(
...
init|=
block|{
literal|2253062534070272L
block|,
literal|598134367453184L
block|,
