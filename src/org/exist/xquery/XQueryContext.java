...
name|XPathException
argument_list|(
literal|"Namespace not a URI, namespaceURI="
operator|+
name|namespace
argument_list|,
name|ex
...
argument_list|)
decl_stmt|;
comment|// try the standard XQuery URI space
if|if
condition|(
name|resolved
operator|==
...
name|XPathException
argument_list|(
literal|"Problem resolving package from expath repository"
argument_list|,
name|ex
argument_list|)
throw|;
