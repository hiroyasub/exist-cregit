...
return|;
block|}
comment|/** 	 * Utility method to create a new in-memory document using the 	 * provided DocBuilder interface. 	 *  	 * @param builder a supplied {@link DocBuilder} 	 * @return the document element of the created document 	 */
specifier|public
name|NodeValue
name|createDocument
parameter_list|(
