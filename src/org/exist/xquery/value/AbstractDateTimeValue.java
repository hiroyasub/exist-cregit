...
name|compile
argument_list|(
literal|"^(\\d\\d\\d\\d-\\d\\d-\\d\\dT)(\\d\\d):(\\d\\d):(\\d\\d)(\\.)((\\d\\d\\d)|(\\d\\d)|(\\d))"
argument_list|)
decl_stmt|;
specifier|protected
specifier|static
...
name|compile
argument_list|(
literal|"^(\\d\\d\\d\\d-\\d\\d-\\d\\d)(T)(\\d\\d):(\\d\\d):(\\d\\d)([+-])(\\d\\d):(\\d\\d)"
argument_list|)
decl_stmt|;
specifier|protected
specifier|static
...
return|;
block|}
comment|//(\\d\\d):(\\d\\d):(\\d\\d)(\\.)(\\d\\d\\d)([+-])(\\d\\d):(\\d\\d)
name|m
operator|=
name|timeMsWTZ
operator|.
...
argument_list|)
expr_stmt|;
comment|//^(\\d\\d\\d\\d-\\d\\d-\\d\\d)(T)(\\d\\d):(\\d\\d):(\\d\\d)
name|m
operator|=
name|dateTimeNoTZ
operator|.
...
return|;
block|}
comment|//(\\d\\d\\d\\d-\\d\\d-\\d\\d)(T)(\\d\\d):(\\d\\d):(\\d\\d)([+-])(\\d\\d):(\\d\\d)
name|m
operator|=
name|dateTimeWTZ
operator|.
...
return|;
block|}
comment|//^(\\d\\d\\d\\d-\\d\\d-\\d\\dT)(\\d\\d):(\\d\\d):(\\d\\d)(\\.)((\\d\\d\\d)|(\\d\\d)|(\\d))
name|m
operator|=
name|dateTimeMsNoTZ
operator|.
...
return|;
block|}
comment|//^(\\d\\d\\d\\d-\\d\\d-\\d\\dT)(\\d\\d):(\\d\\d):(\\d\\d)(\\.)(\\d\\d\\d)([+-])(\\d\\d):(\\d\\d)
name|m
operator|=
name|dateTimeMsWTZ
operator|.
