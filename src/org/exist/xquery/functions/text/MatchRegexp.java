...
return|;
block|}
comment|/* (non-Javadoc) 	 * @see org.exist.xquery.functions.ExtFulltext#evalQuery(org.exist.xquery.StaticContext, org.exist.dom.persistent.DocumentSet, java.lang.String, org.exist.dom.persistent.NodeSet) 	 */
specifier|public
name|Sequence
name|evalQuery
parameter_list|(
...
block|}
block|}
comment|/** 	 * Translates the regular expression from XPath2 syntax to java regex 	 * syntax. 	 * 	 * @param pattern Xpath2 expression 	 * @return Java regexp representation of pattern 	 * @throws XPathException 	 */
specifier|protected
name|String
name|translateRegexp
parameter_list|(
