...
argument_list|)
block|,
comment|//        new FunctionDef(MatchRegexp.signatures[0], MatchRegexp.class),
comment|//        new FunctionDef(MatchRegexp.signatures[1], MatchRegexp.class),
comment|//        new FunctionDef(MatchRegexp.signatures[2], MatchRegexp.class),
comment|//        new FunctionDef(MatchRegexp.signatures[3], MatchRegexp.class),
operator|new
name|FunctionDef
argument_list|(
name|FilterNested
