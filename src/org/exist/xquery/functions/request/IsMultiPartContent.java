...
argument_list|)
argument_list|,
literal|"Determine if the request contains multipart/form-data"
argument_list|,
literal|null
argument_list|,
operator|new
...
name|EXACTLY_ONE
argument_list|,
literal|"true is the request is a multipart/form-data request else false."
argument_list|)
argument_list|)
decl_stmt|;
