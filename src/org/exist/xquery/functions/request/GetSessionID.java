...
comment|//get the request variable
name|Variable
name|var
init|=
name|myModule
...
argument_list|)
decl_stmt|;
comment|//is the Request variable ok?
if|if
condition|(
name|var
operator|==
...
argument_list|)
throw|;
comment|//get an ObjectValue from the request variable
name|JavaObjectValue
name|value
init|=
operator|(
...
argument_list|)
decl_stmt|;
comment|//is the ObjectValue's object an instance of RequestWrapper (i.e. is it the right type)
if|if
condition|(
name|value
operator|.
...
argument_list|()
decl_stmt|;
comment|//get the session from the request
name|SessionWrapper
name|session
init|=
name|request
