...
begin_comment
comment|/*  *  eXist Open Source Native XML Database  *  Copyright (C) 2001-04 Wolfgang M. Meier  *  wolfgang@exist-db.org  *  http://exist.sourceforge.net  *    *  This program is free software; you can redistribute it and/or  *  modify it under the terms of the GNU Lesser General Public License  *  as published by the Free Software Foundation; either version 2  *  of the License, or (at your option) any later version.  *    *  This program is distributed in the hope that it will be useful,  *  but WITHOUT ANY WARRANTY; without even the implied warranty of  *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the  *  GNU Lesser General Public License for more details.  *    *  You should have received a copy of the GNU Lesser General Public License  *  along with this program; if not, write to the Free Software  *  Foundation, Inc., 675 Mass Ave, Cambridge, MA 02139, USA.  *    *  $Id: GetUploadedFile.java 790 2004-10-29 09:20:54 +0100 (Fri, 29 Oct 2004) wolfgang_m $  */
end_comment
...
argument_list|)
argument_list|,
literal|"Retrieve the Java file object where the file part of a multi-part request has been stored. "
operator|+
...
argument_list|)
argument_list|,
literal|"Deprecated in favour of get-uploaded-file-data()"
argument_list|)
block|,
operator|new
name|FunctionSignature
...
name|QName
argument_list|(
literal|"get-uploaded-file-data"
argument_list|,
name|RequestModule
operator|.
name|NAMESPACE_URI
...
argument_list|)
argument_list|,
literal|"Retrieve the base64 encoded data where the file part of a multi-part request has been stored. "
operator|+
literal|"Returns the empty sequence if the request is not a multi-part request or the parameter name "
operator|+
literal|"does not point to a file part."
