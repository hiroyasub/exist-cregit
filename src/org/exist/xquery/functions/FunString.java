...
argument_list|)
argument_list|,
literal|"Returns the value of $a as xs:string. "
operator|+
literal|"If the value of $ is the empty sequence, the zero-length string is returned. "
operator|+
literal|"If the context item of $a is undefined, an error is raised."
argument_list|,
operator|new
name|SequenceType
index|[]
