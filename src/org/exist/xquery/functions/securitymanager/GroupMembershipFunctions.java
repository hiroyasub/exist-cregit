...
name|qnGetGroupMembers
argument_list|,
literal|"Gets a list of the group members. Can only be called by a group manager."
argument_list|,
operator|new
name|SequenceType
index|[]
...
condition|)
block|{
comment|//TODO this assertion should be moved into the security manager once the groups<-> users relationship is inverted
name|Group
name|group
init|=
name|manager
...
name|PermissionDeniedException
argument_list|(
literal|"You must be a manager to list group membership"
argument_list|)
throw|;
block|}
comment|//end assertion
name|List
argument_list|<
name|Account
argument_list|>
