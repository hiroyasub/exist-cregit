...
argument_list|()
decl_stmt|;
comment|//TODO : use sub-type method here that eventually will throw an exception ? -pb
if|if
condition|(
name|nextValue
operator|.
...
argument_list|)
expr_stmt|;
comment|//TODO : use ComputableValue.max with the collector ! -pb
if|if
condition|(
name|Type
operator|.
