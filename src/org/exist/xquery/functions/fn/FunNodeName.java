...
operator|+
literal|"of nodes it returns the empty sequence. If the context item is the empty sequence, the "
operator|+
...
literal|"Returns an expanded-QName for node kinds that can have names. For other kinds "
operator|+
literal|"of nodes it returns the empty sequence. If $arg is the empty sequence, the "
operator|+
literal|"empty sequence is returned."
argument_list|,
operator|new
...
argument_list|()
decl_stmt|;
comment|//Returns an expanded-QName for node kinds that can have names.
if|if
condition|(
name|n
operator|instanceof
