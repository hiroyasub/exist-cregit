...
return|;
block|}
comment|/**      * High performance non-recurisve implementation of fold-right      * relies on the provided iterator moving in reverse      *      * @param seq An iterator which moves from right to left      */
specifier|private
name|Sequence
name|foldRightNonRecursive
parameter_list|(
