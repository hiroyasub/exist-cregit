...
name|ZERO_OR_MORE
argument_list|,
literal|"all nodes that the shared lock will be placed on their owning documents."
argument_list|)
block|,
operator|new
name|FunctionParameterSequenceType
...
name|ZERO_OR_MORE
argument_list|,
literal|"The expression to be evaluated before the acquired locks are released."
argument_list|)
block|}
argument_list|,
operator|new
