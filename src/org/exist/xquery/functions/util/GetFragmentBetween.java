...
return|;
block|}
comment|/**    * Fetch the fragment between two nodes (normally milestones) in an XML document    * @param fromNode first node from which down to the node toNode the XML fragment is delivered as a string (e.g. //pb[10])    * @param toNode the node to which down the XML fragment is delivered as a string (e.g. //pb[11])    * @return fragment between the two nodes    * @throws XPathException    */
specifier|private
name|StringBuffer
name|getFragmentBetween
parameter_list|(
