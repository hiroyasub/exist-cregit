...
name|node
decl_stmt|;
comment|//Horrible hacks to work-around bad in-scope NS
if|if
condition|(
name|proxy
operator|.
...
condition|)
block|{
comment|//Remember that a temporary node is wrapped by an<exist:temp> element
comment|//The prefix could have been removed from the global context
name|prefix
operator|=
name|element
operator|.
