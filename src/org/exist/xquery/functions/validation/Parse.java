...
name|ZERO_OR_ONE
argument_list|,
literal|"Location of grammar file."
argument_list|)
block|,
operator|new
name|FunctionParameterSequenceType
...
argument_list|)
expr_stmt|;
comment|// Special case for DTD, the document needs to be rewritten.
if|if
condition|(
name|grammarUrl
operator|.
...
name|XPathException
argument_list|(
literal|"Grammar type not supported."
argument_list|)
throw|;
block|}
block|}
