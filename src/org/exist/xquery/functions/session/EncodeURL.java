...
name|BasicFunction
block|{
comment|//	private static final Logger logger = LogManager.getLogger(EncodeURL.class);
specifier|public
specifier|final
specifier|static
...
expr_stmt|;
block|}
comment|/* (non-Javadoc) 	 * @see org.exist.xquery.Function#eval(org.exist.dom.persistent.DocumentSet, org.exist.xquery.value.Sequence, org.exist.xquery.value.Item) 	 */
specifier|public
name|Sequence
name|eval
parameter_list|(
