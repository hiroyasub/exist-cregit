...
argument_list|)
argument_list|,
literal|"$arg is first reduced to an effective boolean value by applying "
operator|+
literal|"the fn:boolean() function. Returns true if the effective boolean "
operator|+
...
name|EXACTLY_ONE
argument_list|,
literal|"the negative of the $arg"
argument_list|)
argument_list|)
decl_stmt|;
specifier|private
