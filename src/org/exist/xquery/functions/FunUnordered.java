...
argument_list|)
argument_list|,
literal|"Takes a sequence as input and returns an arbitrary implementation dependent permutation "
operator|+
literal|"of the input sequence. Currently, this has no effect in eXist, but it might be used for future optimizations."
argument_list|,
operator|new
name|SequenceType
index|[]
