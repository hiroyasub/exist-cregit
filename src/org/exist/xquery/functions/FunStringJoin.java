...
operator|+
literal|"$a sequence using $b as a separator. If the value of $b is the zero-length "
operator|+
literal|"string, then the members of $a are concatenated without a separator."
argument_list|,
operator|new
name|SequenceType
index|[]
