...
block|}
block|}
comment|/** 	 * Retrieve a document. The document data is returned as a string. 	 *  	 * @deprecated use {@link #getDocumentAsString(User, String, Hashtable)} instead. 	 */
specifier|public
name|String
...
block|}
block|}
comment|/** 	 *  This method is provided to retrieve a document with encodings other than 	 *  UTF-8. Since the data is handled as binary data, character encodings are 	 *  preserved. byte[]-values are automatically BASE64-encoded by the XMLRPC 	 *  library. 	 * 	 *@param  name                           Description of the Parameter 	 *@param  parametri                       Description of the Parameter 	 *@param  user                           Description of the Parameter 	 *@return                                The document value 	 *@exception  EXistException             Description of the Exception 	 *@exception  PermissionDeniedException  Description of the Exception 	 */
specifier|public
name|byte
index|[]
name|getDocument
