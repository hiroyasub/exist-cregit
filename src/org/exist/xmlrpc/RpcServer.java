...
argument_list|)
decl_stmt|;
comment|//        gzos.setMethod(gzos.DEFLATED);
comment|//        gzos.putNextEntry(new ZipEntry(length + ""));
name|gzos
operator|.
name|write
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//        ZipEntry zipentry = gzis.getNextEntry();
comment|//        int len = Integer.parseInt(zipentry.getName());
name|ByteArrayOutputStream
name|baos
init|=
operator|new
