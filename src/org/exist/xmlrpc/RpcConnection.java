...
return|;
block|}
comment|/**      * The method<code>execute</code>      *      * @param xpath a<code>String</code> value      * @param parameters a<code>HashMap</code> value      * @return a<code>HashMap</code> value      * @exception Exception if an error occurs      */
specifier|public
name|HashMap
name|execute
parameter_list|(
