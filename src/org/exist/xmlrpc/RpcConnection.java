...
throw|;
block|}
comment|//if(!collection.getPermissions().validate(user, Permission.READ)) {
comment|//	throw new PermissionDeniedException("Insufficient privileges to read resource");
comment|//}
name|doc
operator|=
name|collection
...
comment|//  throw new PermissionDeniedException("Insufficient privileges to read resource " + docName);
comment|//}
name|String
name|encoding
init|=
...
block|}
block|}
comment|/**      * The method<code>getCollectionListing</code>      *      * @param collName a<code>String</code> value      * @return a<code>Vector</code> value      * @exception EXistException if an error occurs      * @exception PermissionDeniedException if an error occurs      * @exception URISyntaxException if an error occurs      */
annotation|@
name|Override
specifier|public
name|Vector
...
return|;
block|}
comment|/**      * The method<code>getCollectionListing</code>      *      * @param collUri a<code>XmldbURI</code> value      * @return a<code>Vector</code> value      * @exception EXistException if an error occurs      * @exception PermissionDeniedException if an error occurs      */
specifier|private
name|Vector
argument_list|<
name|String
...
return|;
block|}
comment|/**      * The method<code>addAccount</code>      *      * @param name a<code>String</code> value      * @param passwd a<code>String</code> value      * @param passwdDigest a<code>String</code> value      * @param groups a<code>Vector</code> value      * @return a<code>boolean</code> value      * @exception EXistException if an error occurs      * @exception PermissionDeniedException if an error occurs      */
annotation|@
name|Override
specifier|public
name|boolean
