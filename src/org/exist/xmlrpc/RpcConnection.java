...
argument_list|()
decl_stmt|;
comment|// A tweak for very large XML resources
if|if
condition|(
name|doc
operator|.
...
argument_list|()
decl_stmt|;
comment|// A tweak for very large binary resources
if|if
condition|(
name|doc
operator|.
...
block|}
block|}
comment|/**      * The method<code>getChunk</code>      *      * @param file a<code>File</code> value      * @param offset a<code>long</code> value      * @return a<code>byte[]</code> value      * @exception IOException if an error occurs      */
specifier|private
name|byte
index|[]
name|getChunk
