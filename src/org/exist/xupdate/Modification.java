...
name|EXistException
argument_list|(
literal|"Error in calling user trigger"
argument_list|,
name|e
argument_list|)
throw|;
...
block|}
block|}
comment|/** get applicable trigger according to Collection Configuration */
specifier|private
name|DocumentTrigger
name|getTrigger
parameter_list|(
...
return|;
block|}
comment|/** 	 * Release all acquired document locks; 	 * feature trigger_update : 	 * at the same time we leverage on the fact that it's called after  	 * database modification to call the eventual triggers 	 * @param transaction 	 */
specifier|protected
specifier|final
name|void
...
argument_list|)
expr_stmt|;
comment|// and then call eventual triggers
name|Iterator
name|iterator
init|=
name|lockedDocuments
...
name|finish
argument_list|(
comment|// event, broker, transaction, document)
name|Trigger
operator|.
name|UPDATE_DOCUMENT_EVENT
argument_list|,
