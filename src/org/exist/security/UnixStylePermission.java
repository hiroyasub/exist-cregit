...
name|IOException
block|{
comment|/*final SecurityManager secman = broker.getBrokerPool().getSecurityManager();         if (secman == null) {             //TODO : load default permissions ? -pb             permissions.setOwner(broker.getSubject(), SecurityManager.DBA_USER);             permissions.setGroup(broker.getSubject(), SecurityManager.DBA_GROUP);         } else {*/
name|this
operator|.
name|owner
operator|=
