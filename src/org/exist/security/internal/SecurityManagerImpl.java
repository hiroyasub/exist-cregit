...
literal|"2.0"
decl_stmt|;
comment|//	@ConfigurationField("default-collection-permissions")
comment|//	@ConfigurationFieldSettings("radix=8")
specifier|private
name|int
name|defaultCollectionPermissions
init|=
name|Permission
operator|.
name|DEFAULT_PERM
decl_stmt|;
comment|//	@ConfigurationField("default-resource-permissions")
comment|//	@ConfigurationFieldSettings("radix=8")
specifier|private
name|int
name|defaultResourcePermissions
init|=
name|Permission
operator|.
name|DEFAULT_PERM
