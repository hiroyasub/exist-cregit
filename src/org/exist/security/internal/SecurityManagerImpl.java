...
comment|//       Integer defOpt = (Integer)
comment|//       broker.getConfiguration().getProperty(PROPERTY_PERMISSIONS_COLLECTIONS);
comment|//       if (defOpt != null)
comment|//          defCollectionPermissions = defOpt.intValue();
comment|//       defOpt = (Integer)
comment|//       broker.getConfiguration().getProperty(PROPERTY_PERMISSIONS_RESOURCES);
comment|//       if (defOpt != null)
comment|//          defResourcePermissions = defOpt.intValue();
comment|//
comment|//       Boolean enableXACML = (Boolean)broker.getConfiguration().getProperty("xacml.enable");
comment|//       if(enableXACML != null&& enableXACML.booleanValue()) {
comment|//          pdp = new ExistPDP(pool);
comment|//          LOG.debug("XACML enabled");
comment|//       }
block|}
specifier|public
name|boolean
