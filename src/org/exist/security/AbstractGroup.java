...
name|PermissionDeniedException
argument_list|(
literal|"Only existing managers or DBA's may add a new manager to a group"
argument_list|)
throw|;
block|}
name|_addManager
...
name|PermissionDeniedException
argument_list|(
literal|"Only existing managers or DBA's may remove another manager from a group"
argument_list|)
throw|;
block|}
for|for
