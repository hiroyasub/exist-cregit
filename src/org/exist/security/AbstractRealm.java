...
return|;
block|}
comment|/*     protected interface Unit<R> {         public R execute(DBBroker broker) throws EXistException, PermissionDeniedException;     }          protected<R> R executeAsSystemUser(Unit<R> unit) throws EXistException, PermissionDeniedException {                  DBBroker broker = null;         Subject currentSubject = getDatabase().getSubject();         try {             //elevate to system privs             broker = getDatabase().get(getSecurityManager().getSystemSubject());                                  return unit.execute(broker);         } finally {             if(broker != null) {                 broker.setSubject(currentSubject);                 getDatabase().release(broker);             }         }     }*/
