...
specifier|public
name|void
name|testValidateContentsSinglePass
parameter_list|()
throws|throws
name|XMLDBException
block|{
...
name|println
argument_list|(
literal|"ValidateContentsSinglePass:"
argument_list|)
expr_stmt|;
name|System
operator|.
...
expr_stmt|;
block|}
comment|/*public void testGetElementByXPath() throws XMLDBException {       insertSchemas();       //getSchemaService().getElement("/schema/element[@name='bill']");   }*/
specifier|public
name|void
name|testGetType
parameter_list|()
