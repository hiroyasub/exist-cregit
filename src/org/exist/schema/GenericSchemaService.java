...
begin_comment
comment|//import org.apache.tools.ant.filters.StringInputStream;
end_comment
...
argument_list|()
decl_stmt|;
comment|/*try {         SchemaTypeSystem sts = XmlBeans.compileXsd(new XmlObject[] { XmlObject.Factory.parse(new StringInputStream(             schema)) }, XmlBeans.getBuiltinTypeSystem(), null);         String s = sts.compileQuery(xpath, null);         System.out.println(s);       } catch (XmlException e) {         throw new XMLDBException(ErrorCodes.VENDOR_ERROR, "Cannot read schema. ", e);       } catch (IOException e) {         throw new XMLDBException(ErrorCodes.VENDOR_ERROR, "Cannot read schema. ", e);       }*/
block|}
else|else
block|{
throw|throw
