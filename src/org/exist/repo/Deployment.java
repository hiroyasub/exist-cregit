...
condition|)
block|{
comment|// a library package does not have a target collection, but we still return
comment|// the temporary location of the package in /db/system
specifier|final
name|String
name|pkgColl
init|=
...
argument_list|()
expr_stmt|;
comment|// check for resourcepath elements
name|InMemoryNodeSet
name|resources
init|=
name|findElements
...
block|}
block|}
comment|/**      * Scan a directory and import all files and sub directories into the target      * collection.      *      * @param directory      * @param target      * @param resources set of resource elements being present in repo.xml      */
specifier|private
name|void
name|scanDirectory
parameter_list|(
...
return|;
block|}
comment|//TODO(AR) should return Optional or throw exception
specifier|public
name|DocumentImpl
name|getDescriptor
parameter_list|(
