...
block|{
comment|//XXX: need refactoring -shabanovd
comment|//                String path = props.getProperty(name + ".context", "/" + name + "/*");
comment|//                String sname = props.getProperty(name + ".name", name);
comment|//                ServletHolder servlet = context.addServlet(props.getProperty(name + ".class"), path);
comment|//                servlet.setName(sname);
comment|//                String paramPrefix = name + ".param.";
comment|//                for (Enumeration pnames = props.propertyNames(); pnames.hasMoreElements();) {
comment|//                    String pname = (String) pnames.nextElement();
comment|//                    if (pname.startsWith(paramPrefix)) {
comment|//                        String theName = pname.substring(paramPrefix.length());
comment|//                        servlet.setInitParameter(theName, props.getProperty(pname));
comment|//                    }
comment|//                }
block|}
block|}
