...
operator|+
literal|"Use in conjunction with -X to specify the resource to "
operator|+
literal|"update."
argument_list|)
block|,
...
expr_stmt|;
block|}
comment|// in local-mode: shutdown the db
if|if
condition|(
name|current
operator|.
...
name|equals
argument_list|(
literal|"org.exist.xmldb.LocalCollection"
argument_list|)
condition|)
name|shutdown
argument_list|()
