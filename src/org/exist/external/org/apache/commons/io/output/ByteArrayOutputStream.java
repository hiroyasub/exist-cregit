...
expr_stmt|;
block|}
comment|/**      * Return the appropriate<code>byte[]</code> buffer      * specified by index.      *      * @param index  the index of the buffer required      * @return the buffer      */
specifier|private
name|byte
index|[]
name|getBuffer
