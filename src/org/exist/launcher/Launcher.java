...
argument_list|,
literal|"Running eXist-db via the launcher does not appear to be supported on your platform. "
operator|+
...
operator|+
literal|"Please run it using bin/startup.sh or bin\\startup.bat."
argument_list|,
literal|false
argument_list|)
expr_stmt|;
