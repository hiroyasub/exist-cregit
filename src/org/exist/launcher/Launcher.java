...
name|message
argument_list|,
literal|"Starting Server Failed"
argument_list|,
name|JOptionPane
operator|.
name|ERROR_MESSAGE
...
name|showTrayMessage
argument_list|(
literal|"Stopping the eXistdb service. Please wait..."
argument_list|,
name|TrayIcon
operator|.
name|MessageType
...
name|message
argument_list|,
literal|"Stopping Server Failed"
argument_list|,
name|JOptionPane
operator|.
name|ERROR_MESSAGE
...
name|WrapperWin32Service
operator|.
name|SERVICE_STATE_RUNNING
operator|||
name|state
operator|==
name|WrapperWin32Service
operator|.
name|SERVICE_STATE_START_PENDING
operator|||
name|state
operator|==
name|WrapperWin32Service
operator|.
name|SERVICE_STATE_CONTINUE_PENDING
decl_stmt|;
if|if
condition|(
name|installServiceItem
