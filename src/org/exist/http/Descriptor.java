...
expr_stmt|;
block|}
comment|//if cant read Descriptor from specified home folder
if|if
condition|(
operator|!
name|f
...
name|info
argument_list|(
literal|"Unable to read descriptor. Trying to guess location ..."
argument_list|)
expr_stmt|;
comment|//Read from the Descriptor file from the guessed home folder
if|if
condition|(
name|dbHome
operator|==
