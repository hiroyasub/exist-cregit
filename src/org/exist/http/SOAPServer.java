...
expr_stmt|;
block|}
comment|/**      * Gets XQWS file from the db      *       * @param broker 	The Database Broker to use      * @param path		The Path to the XQWS      * @param docXQWS	A reference to a Binary Document, will be the XQWS file when the function returns      *       * @return	The XQWS BinaryDocument      */
specifier|private
name|BinaryDocument
name|getXQWS
parameter_list|(
...
return|;
block|}
comment|/**      * Gets the data from an XQWS Binary Document      */
specifier|private
name|byte
index|[]
name|getXQWSData
...
specifier|private
name|CompiledXQuery
name|SimpleXQueryIncludeModule
parameter_list|(
name|DBBroker
name|broker
parameter_list|,
...
argument_list|)
decl_stmt|;
comment|// 3) Compile a Simple XQuery to access the module
name|CompiledXQuery
name|compiled
decl_stmt|;
try|try
...
expr_stmt|;
block|}
comment|//do the transformation to the response
name|StreamTransform
argument_list|(
name|broker
argument_list|,
...
name|IOException
block|{
comment|//read the incoming SOAP request
name|java
operator|.
name|io
operator|.
...
argument_list|)
expr_stmt|;
comment|//create an XML Document from the SOAP Request
name|Document
name|soapRequest
init|=
...
argument_list|)
decl_stmt|;
comment|//Examine the SOAP Request
name|System
operator|.
name|out
operator|.
