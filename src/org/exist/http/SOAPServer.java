...
argument_list|)
expr_stmt|;
comment|//add a comma if this isnt the last parameter
if|if
condition|(
name|j
operator|!=
...
comment|//NodeList nlBody = soapRequest.getElementsByTagNameNS("http://schemas.xmlsoap.org/soap/envelope/", "Body");
name|NodeList
name|nlBody
init|=
name|soapRequest
...
argument_list|)
expr_stmt|;
comment|//TODO: this will work for a single string result, but need to add much more logic for other types and complex cardinalities
name|builderFunction
operator|.
name|characters
argument_list|(
