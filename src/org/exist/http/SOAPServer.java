...
argument_list|)
decl_stmt|;
comment|//first child of function should be name
name|Node
name|nFunctionName
init|=
name|nFunction
...
parameter_list|)
block|{
comment|//first child of<parameter> is<name>
return|return
name|internalFunctionParameter
operator|.
name|getFirstChild
...
parameter_list|)
block|{
comment|//second child of<parameter> is<type>
return|return
name|internalFunctionParameter
operator|.
name|getChildNodes
...
parameter_list|)
block|{
comment|//last child of<parameter> is<cardinality>
name|String
name|strCardinality
init|=
name|internalFunctionParameter
