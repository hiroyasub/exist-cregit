...
argument_list|()
expr_stmt|;
comment|//String output = serializer.serialize(resource);
comment|//writeResponse(response, output, encoding);
block|}
catch|catch
parameter_list|(
name|SAXException
...
block|}
block|}
comment|/**      * Handles PUT requests. The request content is stored as a new resource at      * the specified location. If the resource already exists, it is overwritten if the      * user has write permissions.      *      * The resource type depends on the content type specified in the HTTP header.      * The content type will be looked up in the global mime table. If the corresponding      * mime type is not a know XML mime type, the resource will be stored as a binary      * resource.      *      * @param broker      * @param tempFile      * @param contentType      * @param path      * @return      * @throws BadRequestException      * @throws PermissionDeniedException      */
specifier|public
name|void
name|doPut
parameter_list|(
