...
name|ServletException
argument_list|(
literal|"attribute path of<exist:dispatch> should not be empty."
argument_list|)
throw|;
name|rewrite
operator|=
...
name|ServletException
argument_list|(
literal|"attribute servlet-name of<exist:dispatch> should not be empty."
argument_list|)
throw|;
name|rewrite
operator|=
...
name|ServletException
argument_list|(
literal|"attribute redirect of<exist:dispatch> should not be empty."
argument_list|)
throw|;
name|rewrite
operator|=
...
name|ServletException
argument_list|(
literal|"Element<exist:dispatch> should either provide "
operator|+
literal|"an attribute 'path' or 'servlet-name'. Received: "
operator|+
name|resource
operator|.
name|getContent
...
name|ServletException
argument_list|(
literal|"An error occurred while executing the redirect XQuery: "
operator|+
name|e
operator|.
name|getMessage
