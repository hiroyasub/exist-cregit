...
return|;
block|}
comment|/**      * Configures all index modules registered with the db instance.      *       * @param configNodes lists the top-level child nodes below the&lt;index&gt; element in collection.xconf      * @param namespaces the active prefix/namespace map      * @return an arbitrary configuration object to be kept for this index in the collection configuration      * @throws DatabaseConfigurationException if a configuration error occurs      */
specifier|public
name|Map
name|configure
parameter_list|(
...
return|;
block|}
comment|/**      * Flushes all index modules.      */
specifier|public
name|void
name|flush
parameter_list|()
...
expr_stmt|;
block|}
comment|/**      * Remove all indexes defined on the specified collection.      *      * @param collection the collection to remove      */
specifier|public
name|void
