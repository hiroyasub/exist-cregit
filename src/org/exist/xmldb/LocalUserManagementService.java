...
name|XMLDBException
block|{
comment|//TODO this will cause problems if perm is of type org.exist.security.interal.aider.UnixStylePermissionAider
if|if
condition|(
name|perm
operator|instanceof
...
argument_list|(
literal|"ERROR, aider.UnixStylePermission cannot be used here"
argument_list|)
throw|;
block|}
name|org
