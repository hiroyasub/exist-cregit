...
literal|':'
decl_stmt|;
comment|//protected XmlRpcClient rpcClient;
specifier|private
name|HashMap
name|rpcClients
init|=
...
throw|;
block|}
comment|/**      * @param user      * @param password      * @param address      * @param c      * @return      * @throws XMLDBException      */
specifier|private
name|Collection
name|getRemoteCollection
parameter_list|(
...
return|;
block|}
comment|/**      * @param user      * @param c      * @return      * @throws XMLDBException      */
specifier|private
name|Collection
name|getLocalCollection
parameter_list|(
