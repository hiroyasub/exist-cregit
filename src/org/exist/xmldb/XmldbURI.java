...
name|apiName
decl_stmt|;
comment|/** 	 * @param xmldbURI Contructs an XmldbURI by parsing the given string.  	 * Note that we construct URIs starting with XmldbURI.XMLDB_URI_PREFIX. 	 * Do not forget that org.xmldb.api.DatabaseManager<strong>trims</strong> this prefix. 	 * @throws URISyntaxException If the given string is not a valid xmldb URI. 	 */
specifier|public
name|XmldbURI
parameter_list|(
name|String
...
literal|1
decl_stmt|;
comment|//TODO : use relative URIs pathes here ?
name|String
name|path
init|=
literal|null
...
argument_list|)
throw|;
comment|//		TODO : everything but contexts must be equal !
name|String
name|context1
init|=
name|this
...
name|NullPointerException
argument_list|(
literal|"The provided String is null"
argument_list|)
throw|;
try|try
block|{
