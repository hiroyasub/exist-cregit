...
begin_comment
comment|/** Try to reproduce the EXistException "the document is too complex/irregularily structured  * to be mapped into eXist's numbering scheme"  * raised in {@link org/exist/dom/DocumentImpl} , but didn't succed yet ;-) .  * It creates with DOM a simple document having 10000 elements   * connected to the root, and the first element having a sub-tree of large depth, etc.  * It uses reproductible randomness.  *  */
end_comment
