...
block|}
block|}
comment|/**      * Fallback method to retrieve data from eXist versions< 1.5.      *       * @param handle      * @param pos      * @throws XMLDBException      */
specifier|protected
name|void
name|getRemoteContentFallback
parameter_list|(
name|int
name|handle
parameter_list|,
...
parameter_list|)
block|{
comment|// backwards compatibility with eXist versions< 1.4
name|getRemoteContentFallback
argument_list|(
name|handle
argument_list|,
