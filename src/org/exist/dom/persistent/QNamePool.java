...
name|values
decl_stmt|;
comment|//private org.exist.dom.QName temp = new org.exist.dom.QName("", "");
specifier|public
name|QNamePool
parameter_list|()
block|{
...
argument_list|)
decl_stmt|;
comment|//        temp.setLocalPart(localName);
comment|//        temp.setNamespaceURI(namespaceURI);
comment|//        temp.setPrefix(prefix);
comment|//        temp.setNameType(type);
name|int
name|idx
init|=
name|temp
