...
return|;
block|}
comment|/*      * (non-Javadoc)      *      * @see org.exist.dom.persistent.NodeSet#get(org.exist.dom.persistent.NodeProxy)      */
annotation|@
name|Override
specifier|public
name|NodeProxy
...
block|}
block|}
comment|/* (non-Javadoc)      * @see org.exist.dom.persistent.AbstractNodeSet#selectAncestorDescendant(org.exist.dom.persistent.NodeSet,      * int, boolean, boolean)      */
annotation|@
name|Override
specifier|public
name|NodeSet
...
return|;
block|}
comment|/* (non-Javadoc)      * @see org.exist.dom.persistent.AbstractNodeSet#selectSiblings(org.exist.dom.persistent.NodeSet, int)      */
annotation|@
name|Override
specifier|public
name|NodeSet
...
return|;
block|}
comment|/* (non-Javadoc)      * @see org.exist.dom.persistent.AbstractNodeSet#selectAncestors(org.exist.dom.persistent.NodeSet, boolean, boolean)      */
annotation|@
name|Override
specifier|public
name|NodeSet
...
return|;
block|}
comment|/* (non-Javadoc)      * @see org.exist.dom.persistent.NodeSet#getIndexType()      */
annotation|@
name|Override
specifier|public
name|int
...
block|}
block|}
comment|/*      * (non-Javadoc)      *      * @see org.exist.dom.persistent.AbstractNodeSet#hasChanged(int)      */
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|/*      * (non-Javadoc)      *      * @see org.exist.dom.persistent.AbstractNodeSet#getState()      */
annotation|@
name|Override
specifier|public
name|int
