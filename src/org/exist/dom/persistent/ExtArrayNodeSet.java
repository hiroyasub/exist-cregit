...
block|}
comment|//    /**
comment|//     * The method<code>filterDocuments</code>
comment|//     *
comment|//     * @param otherSet an<code>ExtArrayNodeSet</code> value
comment|//     * @return a<code>NodeSet</code> value
comment|//     */
comment|//    public NodeSet filterDocuments(final ExtArrayNodeSet otherSet) {
comment|//        final ExtArrayNodeSet other = otherSet;
comment|//        final ExtArrayNodeSet result = new ExtArrayNodeSet(partCount, other.initialSize);
comment|//        for(int i = 0; i< other.partCount; i++) {
comment|//            final int idx = ArrayUtils.binarySearch(documentIds, other.documentIds[i], partCount);
comment|//            if(idx> -1) {
comment|//                final Part part = parts[idx];
comment|//                int otherIdx = ArrayUtils.binarySearch(result.documentIds,
comment|//                    documentIds[idx], result.partCount);
comment|//                otherIdx = -(otherIdx + 1);
comment|//                result.insertPart(documentIds[idx], part, otherIdx);
comment|//            }
comment|//        }
...
block|}
comment|//    /**
comment|//     * The method<code>setSorted</code>
comment|//     *
comment|//     * @param document a<code>DocumentImpl</code> value
comment|//     * @param sorted   a<code>boolean</code> value
comment|//     */
comment|//    public void setSorted(DocumentImpl document, boolean sorted) {
comment|//        final Part part = getPart(document, false, -1);
comment|//        if(part != null) {
comment|//            part.setIsSorted(sorted);
comment|//        }
comment|//    }
