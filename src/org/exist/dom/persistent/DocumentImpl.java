...
expr_stmt|;
block|}
comment|/**      * Creates a new persistent Document instance.      *      * @param pool The broker pool      * @param collection The Collection which holds this document      * @param fileURI The name of the document      */
specifier|public
name|DocumentImpl
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**      * Creates a new persistent Document instance to replace an existing document instance.      *      * @param prevDoc The previous Document object that we are overwriting      */
specifier|public
name|DocumentImpl
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**      * Creates a new persistent Document instance to replace an existing document instance.      *      * @param pool The broker pool      * @param collection The Collection which holds this document      * @param prevDoc The previous Document object that we are overwriting      */
specifier|public
name|DocumentImpl
parameter_list|(
specifier|final
