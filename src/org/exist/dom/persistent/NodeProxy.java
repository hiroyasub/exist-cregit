...
name|UNKNOWN_NODE_TYPE
decl_stmt|;
comment|/**      * The first {@link Match} object associated with this node.      * Match objects are used to track fulltext hits throughout query processing.      *<p/>      * Matches are stored as a linked list.      */
specifier|private
name|Match
name|match
init|=
