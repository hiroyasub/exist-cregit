...
return|;
block|}
comment|/**      *  Gets the address attribute of the NodeProxy object      *      *@return    The address value      */
specifier|public
name|long
name|getAddress
parameter_list|()
...
return|;
block|}
comment|/**      *  Gets the parent attribute of the NodeProxy object      *      *@return    The parent value      */
specifier|public
name|long
name|getParent
parameter_list|()
...
return|;
block|}
comment|/**      *  Gets the parentAtLevel attribute of the NodeProxy object      *      *@param  level  Description of the Parameter      *@return        The parentAtLevel value      */
specifier|public
name|long
name|getParentAtLevel
parameter_list|(
name|int
name|level
parameter_list|)
...
return|;
block|}
comment|/**      *  Gets the treeLevel attribute of the NodeProxy object      *      *@return    The treeLevel value      */
specifier|public
name|int
name|getTreeLevel
parameter_list|()
...
return|;
block|}
comment|/**      *  Sets the address attribute of the NodeProxy object      *      *@param  address  The new address value      */
specifier|public
name|void
name|setAddress
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      *  Sets the gID attribute of the NodeProxy object      *      *@param  gid  The new gID value      */
specifier|public
name|void
name|setGID
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|/**          *  Description of the Method          *          *@param  obj1  Description of the Parameter          *@param  obj2  Description of the Parameter          *@return       Description of the Return Value          */
specifier|public
name|int
name|compare
parameter_list|(
...
block|}
block|}
comment|/**      * Returns the internalAddress.      * @return long      */
specifier|public
name|long
...
return|;
block|}
comment|/**      * Sets the doc.      * @param doc The doc to set      */
specifier|public
name|void
name|setDoc
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Sets the internalAddress.      * @param internalAddress The internalAddress to set      */
specifier|public
name|void
