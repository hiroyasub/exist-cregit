...
block|}
block|}
comment|/**      * Fast method to add a bunch of documents from a Java collection.      * A lock will be acquired on each document. The locked document is added to the      * specified LockedDocumentMap in order to keep track of the locks..      *      * @param broker      * @param docs      * @param lockMap      * @param lockType      * @throws LockException      */
specifier|public
name|void
name|addAll
parameter_list|(
