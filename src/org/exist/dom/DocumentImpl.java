...
try|try
block|{
comment|//ostream.writeUTF(fileName.substring(collection.getName().length() + 1));
name|ostream
operator|.
name|writeLong
argument_list|(
...
try|try
block|{
comment|//fileName = collection.getName() + '/' + istream.readUTF();
...
argument_list|,
literal|"inserting the node at this position is not allowed"
argument_list|)
throw|;
block|}
block|}
