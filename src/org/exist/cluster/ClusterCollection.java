...
begin_comment
comment|/**  * Created by Francesco Mondora.  *  * @author Francesco Mondora aka Makkina  * @author Michele Danieli aka cinde  *  *         Date: Aug 31, 2004  *         Time: 8:45:47 AM  *         Revision $Revision$  */
end_comment
...
condition|)
block|{
comment|//System.out.println("IS is: " + is);
name|is
operator|.
name|reset
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// System.out.println("CS is: " + cs);
if|if
condition|(
name|cs
operator|!=
...
try|try
block|{
comment|// if (ClusterAwareMain.hasToBePublished(content)) {
name|ClusterClient
name|cc
init|=
operator|new
