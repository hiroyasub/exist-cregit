...
begin_comment
comment|/**  * Ant task to execute an XQuery.<p/> The query is either passed as nested text  * in the element, or via an attribute "query" or via a URL or via a query file  *<p/>  *   * @author peter.klotz@blue-elephant-systems.com  */
end_comment
