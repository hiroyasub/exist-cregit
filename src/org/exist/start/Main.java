...
literal|""
decl_stmt|;
comment|// Pattern that can be used in start.config file to indicate that the
...
expr_stmt|;
block|}
comment|// If the passed file name contains the %latest% token
comment|// find the latest version of that file, otherwise return
comment|// the passed file name unmodified.
specifier|private
name|String
name|getResolvedFileName
parameter_list|(
...
name|actualFileName
operator|+
literal|" for start.config entry: "
operator|+
name|filename
argument_list|)
expr_stmt|;
