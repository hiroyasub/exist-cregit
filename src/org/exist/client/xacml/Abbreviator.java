...
name|println
argument_list|(
literal|" functionId did not start with FUNCTION_NS"
argument_list|)
expr_stmt|;
name|functionMap
operator|.
...
name|println
argument_list|(
literal|" functionId started with FUNCTION_NS, is now '"
operator|+
name|toString
operator|+
literal|"'"
...
name|println
argument_list|(
literal|" functionId was in comparison map, returning '"
operator|+
name|toString
operator|+
literal|"'"
...
name|println
argument_list|(
literal|" functionId was not in comparison map, returning '"
operator|+
name|toString
operator|+
literal|"'"
