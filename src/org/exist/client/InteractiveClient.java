...
name|messageln
argument_list|(
literal|"Please give a resource name."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|messageln
argument_list|(
literal|"validated ok."
argument_list|)
expr_stmt|;
else|else
name|messageln
argument_list|(
literal|"there were errors."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|messageln
argument_list|(
literal|"missing schema file name."
argument_list|)
expr_stmt|;
block|}
else|else
...
block|}
block|}
comment|/** 	 * @param String filename of the file that contains the schema 	 */
specifier|private
name|void
name|importSchema
parameter_list|(
...
name|messageln
argument_list|(
literal|"imported schema in file \""
operator|+
name|filename
operator|+
literal|"\"."
...
name|messageln
argument_list|(
literal|"Unable to parse schema in "
operator|+
name|filename
operator|+
literal|": "
...
name|messageln
argument_list|(
literal|"Uable to parse schema in "
operator|+
name|filename
operator|+
literal|": "
