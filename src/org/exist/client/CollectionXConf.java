...
literal|null
decl_stmt|;
comment|/** 		 * Constructor 		 *  		 * @param QName		The QName to create a qname index on 		 * @param xsType	The data type of the element indicated by QName as an xs:type  		 */
name|QNameIndex
parameter_list|(
name|String
name|QName
...
expr_stmt|;
block|}
comment|//produces a collection.xconf suitable string of XML describing the qname index
specifier|protected
name|String
name|toXMLString
parameter_list|()
