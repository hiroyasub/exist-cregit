...
argument_list|)
expr_stmt|;
comment|//if(triggerEvents != null)
comment|//rangeIndexes[index].setxsType(xsType);
block|}
...
parameter_list|)
block|{
comment|//setup a mapping from org.exist.collections.triggers.Trigger events to trigger names
name|triggerEventNames
operator|.
name|put
argument_list|(
