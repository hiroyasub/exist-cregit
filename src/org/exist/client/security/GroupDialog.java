...
argument_list|)
expr_stmt|;
comment|//TODO add the invoking user to the new group as a member and manager
block|}
specifier|public
name|UserManagementService
...
return|return;
block|}
comment|//TODO (2) needs a function getUserManagementService().addUserToGroup()
comment|//2 - add the users to the group
specifier|final
name|Set
argument_list|<
name|Account
...
block|}
block|}
comment|//TODO (3) needs a function getUserManagementService().addGroupManager();
comment|//3 - add the group managers to the group
try|try
block|{
for|for
control|(
...
name|this
argument_list|,
literal|"Could not add managers to group '"
operator|+
name|txtGroupName
operator|.
name|getText
