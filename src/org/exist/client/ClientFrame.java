...
decl_stmt|;
comment|//$NON-NLS-1$ //$NON-NLS-2$
comment|//UserDialog dialog = new UserDialog(service, Messages.getString("ClientFrame.184"), client); //$NON-NLS-1$
...
block|}
block|}
comment|/**      * @param   properties pass properties to the login panel      * @return  the modiefied properties      */
specifier|protected
specifier|static
name|Properties
name|getLoginData
