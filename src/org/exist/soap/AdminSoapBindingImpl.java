...
argument_list|)
expr_stmt|;
comment|//            if (!resource.startsWith("/"))
comment|//                resource = '/' + resource;
comment|/*if (!name.startsWith("/db"))                 name = "/db" + name;*/
comment|//            resource = NativeBroker.checkPath(resource, "/db");
name|Collection
name|collection
init|=
name|broker
...
argument_list|)
expr_stmt|;
comment|//            if (!name.startsWith("/"))
comment|//                name = '/' + name;
comment|/*if (!name.startsWith("/db"))                 name = "/db" + name;*/
comment|//            name = NativeBroker.checkPath(name, "/db");
name|collection
operator|=
name|broker
operator|.
