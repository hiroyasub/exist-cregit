...
comment|//			GregorianCalendar utccal = new GregorianCalendar();
comment|//			utccal.setTimeZone(TimeZone.getTimeZone("GMT+00:00"));
comment|//			utccal.set(
try|try
block|{
name|XMLGregorianCalendar
...
argument_list|)
decl_stmt|;
comment|//utccal.setTimeInMillis(value);
comment|// Create a XMLGregorianCalendar from the GregorianCalendar
comment|//			try {
comment|//				XMLGregorianCalendar xmlutccal = DatatypeFactory.newInstance().newXMLGregorianCalendar(utccal);
return|return
operator|new
name|DateTimeValue
argument_list|(
...
name|DateTimeValue
argument_list|(
literal|"1960-03-19T19:03:59.782+00:00"
argument_list|)
decl_stmt|;
name|byte
index|[]
