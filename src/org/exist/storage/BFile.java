...
argument_list|)
decl_stmt|;
name|readFreeSpaceList
argument_list|(
name|fp
argument_list|)
expr_stmt|;
block|}
comment|/** 		 *  Description of the Method 		 * 		 *@param  fp               Description of the Parameter 		 *@exception  IOException  Description of the Exception 		 */
specifier|protected
name|void
name|readFreeSpaceList
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|//System.out.println(getFile().getName() +
comment|//		   " removing data page " + old.getPageNum());
try|try
block|{
name|old
operator|.
