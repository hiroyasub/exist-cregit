...
argument_list|)
throw|;
comment|//			int next = rec.offset + 2 + l;
comment|//			ByteConversion.shortToByte(
comment|//				(short) value.length,
comment|//				rec.page.data,
comment|//				rec.offset);
comment|//			rec.offset += 2;
comment|//			System.arraycopy(value, 0, rec.page.data, rec.offset, value.length);
comment|//			rec.offset += value.length;
comment|//			System.arraycopy(
comment|//				rec.page.data,
comment|//				next,
comment|//				rec.page.data,
comment|//				rec.offset,
comment|//				rec.page.getPageHeader().getDataLength() - next);
comment|//			rec.page.len = rec.page.len - (l - value.length);
block|}
if|else if
condition|(
name|value
