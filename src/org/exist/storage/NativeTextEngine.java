...
expr_stmt|;
block|}
comment|/** 	 * Checks if the given string could be a regular expression. 	 *  	 * @param str The string	                  	 * @return  	 */
specifier|public
specifier|final
specifier|static
name|boolean
...
condition|)
block|{
comment|//Exit if the current document is not concerned
if|if
condition|(
operator|!
name|contextSet
...
argument_list|)
expr_stmt|;
comment|//Does the token already exist in the index ?
if|if
condition|(
name|value
operator|!=
