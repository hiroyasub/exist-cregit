...
argument_list|)
expr_stmt|;
comment|//                    LOG.debug(key.dump() + " '" + key.toString() + "'");
block|}
else|else
block|{
name|key
...
expr_stmt|;
block|}
comment|//TODO : find a smarter way to pass the broker
specifier|public
name|QNameWordRef
parameter_list|(
name|short
...
expr_stmt|;
block|}
comment|/** serialize the QName field on the persistent storage */
specifier|private
specifier|static
name|void
name|serializeQName
...
parameter_list|()
block|{
comment|//TODO : what does these 1 stand for ?
return|return
operator|new
name|String
argument_list|(
