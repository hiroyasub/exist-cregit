...
block|}
block|}
comment|/* Drop all index entries for the given document.      * @see org.exist.storage.ContentLoadingObserver#dropIndex(org.exist.dom.persistent.DocumentImpl)      */
specifier|public
name|void
name|dropIndex
parameter_list|(
...
block|}
block|}
comment|/* Return all nodes for wich the matcher matches.      * @see org.exist.storage.TextSearchEngine#getNodes(org.exist.xquery.XQueryContext, org.exist.dom.persistent.DocumentSet, org.exist.dom.persistent.NodeSet, org.exist.storage.TermMatcher, java.lang.CharSequence)      */
specifier|public
name|NodeSet
name|getNodes
parameter_list|(
