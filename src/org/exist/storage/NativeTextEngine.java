...
argument_list|()
expr_stmt|;
comment|//ids = idList.getData();
name|i
operator|.
name|remove
argument_list|()
expr_stmt|;
comment|//Arrays.sort(ids);
comment|//len = ids.length;
name|len
operator|=
name|idList
operator|.
