...
decl_stmt|;
comment|/**      * Timeout for inactive transactions. A transaction which has not processed      * any operations for this time may be considered dead.      */
specifier|public
specifier|final
specifier|static
name|long
name|TXN_INACTIVE_TIMEOUT
init|=
literal|60
operator|*
literal|1000
...
argument_list|()
decl_stmt|;
comment|/**      * Initialize the transaction manager using the specified data directory.      *       * @param pool      * @param dataDir      * @param transactionsEnabled      * @throws EXistException      */
specifier|public
name|TransactionManager
parameter_list|(
specifier|final
