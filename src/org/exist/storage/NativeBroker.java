...
name|domDb
decl_stmt|;
comment|//protected BFile elementsDb;
comment|//protected BFile valuesDb;
comment|//protected BFile valuesDbQname;
comment|//protected BFile dbWords;
...
condition|)
return|return;
comment|// remove the entire collection if all temp data has timed out
name|boolean
name|removeCollection
init|=
literal|true
...
expr_stmt|;
block|}
comment|//notifyDropIndex(document);
if|if
condition|(
name|elementIndex
operator|!=
...
argument_list|)
expr_stmt|;
comment|//TODO : use notification system
name|domDb
operator|.
