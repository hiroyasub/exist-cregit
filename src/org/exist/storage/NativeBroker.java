...
argument_list|)
expr_stmt|;
comment|//Note - permissions are now automaticlaly taken care of at Collection object instantiation time
comment|//Permission perm = current.getPermissions();
comment|//perm.setMode(0777);
comment|//perm.setOwner(getSubject());
comment|//perm.setGroup(getSubject().getPrimaryGroup());
name|current
operator|.
name|setId
argument_list|(
...
name|PermissionDeniedException
argument_list|(
literal|"Insufficient privileges on source collection "
operator|+
name|destination
operator|.
name|getURI
...
block|}
block|}
comment|/**      * Removes a collection and all child collections and resources      *       * @param transaction the transaction to use      * @param collection the collection to remove      * @return true if the collection was removed, false otherwise      * @throws TriggerException       */
annotation|@
name|Override
specifier|public
name|boolean
...
argument_list|)
decl_stmt|;
comment|//canRemoveCollection do check permissions, so remove this one?
if|if
condition|(
operator|!
name|parent
...
expr_stmt|;
block|}
comment|/** move Resource to another collection, with possible rename       * @throws TriggerException */
annotation|@
name|Override
specifier|public
name|void
