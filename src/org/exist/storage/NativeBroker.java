...
argument_list|()
expr_stmt|;
comment|// Initialize symbols storage
comment|//Notice that there is no ID :-(
name|symbols
operator|=
operator|(
name|SymbolTable
...
block|}
block|}
comment|/**      * Removes the temp collection and all child collections and resources      *       * Similar to removeCollection() but makes less use of the Transaction      * in an attempt to remove journalling of temporary resources      *       * @param transaction the transaction to use      * @param collection the collection to remove, initially should be /db/system/temp      *       * @return true if the collection was removed, false otherwise      */
specifier|private
name|boolean
name|removeTempCollection
parameter_list|(
specifier|final
name|Txn
name|transaction
...
argument_list|)
decl_stmt|;
comment|// keep the lock for the transaction, only when removing temp from system
if|if
condition|(
name|transaction
operator|!=
...
name|debug
argument_list|(
literal|"Storing binary resource as a stream "
operator|+
name|blob
operator|.
name|getFileURI
