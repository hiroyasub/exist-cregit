...
argument_list|)
expr_stmt|;
comment|//and free its id for any further use
name|collectionsDb
operator|.
...
name|error
argument_list|(
literal|"LockException while removing documents from collection '"
operator|+
name|collection
operator|.
name|getURI
...
comment|//        try(final ManagedLock managedLock = ManagedLock.acquire(pool.getCollectionCacheLock(), LockMode.WRITE_LOCK)) {
name|pool
operator|.
name|getCollectionsCache
argument_list|()
