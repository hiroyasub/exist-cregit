...
return|;
block|}
comment|/**      * @return A tuple whose first boolean value is set to true if the      * collection was created, or false if the collection already existed      */
specifier|private
name|Tuple2
argument_list|<
name|Boolean
...
block|{
comment|// no parent collection in cache so we need to call this function for the parent Collection
specifier|final
name|Tuple2
argument_list|<
name|Boolean
...
argument_list|)
decl_stmt|;
comment|// is our Collection present on disk?
specifier|final
name|Collection
name|loadedCollection
init|=
...
condition|)
block|{
comment|// new parent Collection... ideally this should never happen unless a database inconsistency
name|LOG
operator|.
name|warn
argument_list|(
literal|"The Collection already existed on disk: {}, but one of the ancestor Collections did not! Will be re-linked..."
argument_list|)
expr_stmt|;
comment|// add it to the parent
name|parentCollection
operator|.
name|addCollection
argument_list|(
...
block|{
comment|// existing parent, add it to the cache and return it
name|collectionsCache
operator|.
name|add
argument_list|(
...
return|;
block|}
comment|/**      * Loads a Collection from disk      *      * @return The Collection object loaded from disk, or null if the record does not exist on disk      */
specifier|private
annotation|@
name|Nullable
name|Collection
...
block|}
block|}
comment|/**      * Get collection object. If the collection does not exist, null is      * returned.      *      * @param path collection URI      * @return The Collection or null if the Collection does not exist      */
specifier|private
annotation|@
name|Nullable
name|Collection
...
throw|;
block|}
comment|// 2) if not in the cache, read from disk
specifier|final
name|Collection
name|loadedCollection
decl_stmt|;
...
block|}
block|}
comment|//TODO(AR) temporary measure
specifier|private
name|ManagedLock
argument_list|<
name|Lock
