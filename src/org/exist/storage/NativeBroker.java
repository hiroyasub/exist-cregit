...
name|DBBroker
block|{
comment|/** file for the typed (range) index */
specifier|static
specifier|final
name|String
name|VALUES_DB_FILE
...
literal|"values.dbx"
decl_stmt|;
comment|/** file for the typed index by qname's */
specifier|static
specifier|final
name|String
...
argument_list|()
expr_stmt|;
comment|// Initialize DOM storage (Document Object Model)
if|if
condition|(
operator|(
name|domDb
...
argument_list|)
decl_stmt|;
comment|// BinaryDocument newBinary =
name|destination
operator|.
...
block|}
block|}
comment|/** Recursively reindex documents and sub-collections  	 * @see #reindex(DocumentImpl, DocumentImpl, NodeImpl) */
specifier|public
name|void
name|reindex
parameter_list|(
...
block|}
block|}
comment|/** Helper method that calls @link #reindex(Collection) */
specifier|public
name|void
name|reindex
parameter_list|(
...
expr_stmt|;
block|}
comment|// jmv TODO reindex(null, root, true);
block|}
comment|/** Recursively remove documents and sub-collections */
specifier|public
name|boolean
...
block|}
block|}
comment|/** Remove document  	 * @param freeDocId Release the document id reserved for a document so it 	 * can be reused. */
specifier|public
name|void
name|removeDocument
parameter_list|(
...
block|}
block|}
comment|/** add Document to Collection; locks the collection. */
specifier|public
name|void
name|addDocument
parameter_list|(
...
block|}
block|}
comment|/** Recursively copy collection inside a destination collection, with possible rename */
specifier|public
name|void
name|copyCollection
parameter_list|(
...
expr_stmt|;
block|}
comment|/** Recursively move collection inside a destination collection, with possible rename */
specifier|public
name|void
name|moveCollection
parameter_list|(
