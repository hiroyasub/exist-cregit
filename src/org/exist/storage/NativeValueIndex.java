...
return|;
block|}
comment|/* (non-Javadoc)      * @see org.exist.storage.ContentLoadingObserver#setDocument(org.exist.dom.persistent.DocumentImpl)      */
specifier|public
name|void
name|setDocument
parameter_list|(
...
block|}
block|}
comment|/* Drop all index entries for the given document.      * @see org.exist.storage.IndexGenerator#dropIndex(org.exist.dom.persistent.DocumentImpl)      */
