...
begin_comment
comment|/**  * Maintains an index on typed node values.  *  *<p>In the BTree single BFile, the keys are : (collectionId, indexType, indexData) and the values are : gid1, gid2-gid1, ...</p>  *  *<p>Algorithm:</p>  *<p>When a node is stored, an entry is added or updated in the {@link #pending} map, with given String content and basic type as key. This way, the  * index entries are easily put in the persistent BFile storage by {@link #flush()} .</p>  *  * @author wolf  */
end_comment
