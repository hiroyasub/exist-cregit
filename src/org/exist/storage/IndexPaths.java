...
return|;
block|}
comment|/**      * Description of the Method      *      * @param path Description of the Parameter      * @param other Description of the Parameter      *      * @return Description of the Return Value      */
specifier|private
specifier|final
specifier|static
name|boolean
...
argument_list|)
expr_stmt|;
comment|//String[] result = new String[tempArray.size()];
comment|//tempArray.toArray( result );
return|return
name|tempArray
return|;
block|}
