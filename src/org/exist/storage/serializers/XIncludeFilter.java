...
block|}
comment|/**      *      * @param href The resource to be xincluded      * @param xpointer      *      * @return Optionally a ResourceError if it was not possible to retrieve the resource      *  to be xincluded      *      * @throws SAXException If a SAX processing error occurs      * @throws PermissionDeniedException When the user does not have permission to read the xincluded resource      */
specifier|protected
name|Optional
argument_list|<
name|ResourceError
