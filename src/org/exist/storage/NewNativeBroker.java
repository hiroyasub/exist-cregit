...
literal|10000
decl_stmt|;
comment|/** Indexer to access the collection db */
specifier|protected
...
literal|null
decl_stmt|;
comment|/** Indexer to access the dom db */
specifier|protected
...
literal|null
decl_stmt|;
comment|/** Indexer to access elements db */
specifier|protected
...
expr_stmt|;
block|}
comment|// finally initialize NativeDomIndexer
name|domIndexer
operator|=
operator|new
name|NativeDomIndexer
...
argument_list|)
expr_stmt|;
comment|// Initialize collection store
name|CollectionStore
name|collectionsDb
init|=
literal|null
...
expr_stmt|;
block|}
comment|// finally initialize NativeCollectionIndexer
name|collectionIndexer
operator|=
operator|new
name|NativeCollectionIndexer
...
argument_list|)
expr_stmt|;
comment|// set readonly attributes
name|collectionIndexer
operator|.
name|setReadOnly
argument_list|(
...
block|}
block|}
comment|/**      * Move later to DBBroker?      */
specifier|public
name|Collection
name|getCollection
parameter_list|(
