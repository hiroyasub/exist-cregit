...
return|;
block|}
comment|/**      * Called from the global sync event to check if caches can      * be shrinked. To be shrinked, the size of a cache needs to be      * larger than the factor defined by {@link #SHRINK_FACTOR}       * and its load needs to be lower than {@link #SHRINK_THRESHOLD}.      *      * If shrinked, the cache will be reset to the default initial cache size.      */
specifier|public
name|void
name|checkCaches
parameter_list|()
