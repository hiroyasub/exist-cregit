...
condition|)
block|{
comment|/* This is already a link, so we just restore it into the old page */
if|if
condition|(
name|rec
operator|.
...
expr_stmt|;
block|}
comment|// copy the link into the old page
name|ByteConversion
operator|.
name|shortToByte
argument_list|(
...
name|TRACE
argument_list|(
literal|"Failed to copy link record from "
operator|+
name|pos
operator|+
literal|"; "
...
control|)
block|{
comment|//            	currentId = (short) ( ( data[pos]& 0xff ) + ( ( data[pos + 1]& 0xff )<< 8 ) );
name|currentId
operator|=
name|ByteConversion
operator|.
...
block|{
comment|//                	vlen = (short) ( ( data[pos + 2]& 0xff ) + ( ( data[pos + 3]& 0xff )<< 8 ) );
name|vlen
operator|=
name|ByteConversion
operator|.
