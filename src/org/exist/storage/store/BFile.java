...
argument_list|)
expr_stmt|;
comment|//System.arraycopy(value, 0, data, 6, value.length);
name|page
operator|.
name|setData
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//System.arraycopy(chunk, 0, page.getData(), ph.getDataLength(), chunkSize);
name|ph
operator|.
name|setDataLength
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//System.arraycopy(chunk, current, page.getData(), 0, chunkSize);
name|page
operator|.
name|setDirty
argument_list|(
...
return|;
block|}
comment|/* (non-Javadoc) 		 * @see java.io.InputStream#close() 		 */
specifier|public
name|void
name|close
parameter_list|()
