...
begin_comment
comment|/**  * Iterate through all nodes of a document in the DOM storage. Returns the  * raw data of the node in a {@link org.dbxml.core.data.Value}. Use class   * {@link org.exist.storage.store.NodeIterator} to get node objects instead of  * raw data.  *   * The DOM file is locked to locate the data and released afterwards. Before  * working with the returned data, you should get a copy by calling value.getData().   *   * @author wolf  */
end_comment
...
argument_list|()
expr_stmt|;
comment|//LOG.debug("Removing link from " + StorageAddress.pageFromPointer(backLink) + "; count=" + ph.getRecordCount());
name|origRec
operator|.
name|page
operator|.
...
condition|)
block|{
comment|//LOG.debug("Removing linked page: " + origRec.page.getPageNum());
name|db
operator|.
name|removePage
argument_list|(
...
argument_list|()
expr_stmt|;
comment|//LOG.debug("removed value from " + p.getPageNum() + "; size=" + ph.getRecordCount());
name|p
operator|.
name|setDirty
argument_list|(
