...
argument_list|()
decl_stmt|;
comment|/**      * Reference count of acquired locks by id and type      *      * Map<Id, Map<Lock Type, Map<Lock Mode, Map<Owner, LockCountTraces>>>>      */
specifier|private
specifier|final
name|ConcurrentMap
argument_list|<
...
name|queueConsumer
decl_stmt|;
comment|/**      * Holds a count of READ and WRITE locks by {@link LockAction#id}      * Only used for debugging, see {@link #sanityCheckLockLifecycles(LockAction)}.      */
specifier|private
specifier|final
name|Map
argument_list|<
...
name|error
argument_list|(
literal|"No entry found when trying to decrementAcquired for: id={}"
operator|+
name|lockAction
operator|.
name|id
...
name|error
argument_list|(
literal|"No entry found when trying to decrementAcquired for: id={}, lockType={}"
argument_list|,
name|lockAction
operator|.
name|id
...
name|error
argument_list|(
literal|"No entry found when trying to decrementAcquired for: id={}, lockType={}, lockMode={}"
argument_list|,
name|lockAction
operator|.
name|id
...
name|error
argument_list|(
literal|"No entry found when trying to decrementAcquired for: id={}, lockType={}, lockMode={}, threadName={}"
argument_list|,
name|lockAction
operator|.
name|id
...
name|error
argument_list|(
literal|"Negative release when trying to decrementAcquired for: id={}, lockType={}, lockMode={}, threadName={}"
argument_list|,
name|lockAction
operator|.
name|id
