...
return|;
block|}
comment|//TODO(AR) at the moment we always exclusively lock the CollectionCache, this can be relaxed once hierarchical Collection locking is in place
comment|//TODO(AR) once hierarchical locking is in place we don't need to lock the collection cache explicitly i.e. externally, it can become a ConcurrentHashMap or Caffeine
specifier|private
specifier|final
name|ReentrantLock
name|collectionCacheLock
init|=
operator|new
name|ReentrantLock
argument_list|()
...
specifier|final
name|String
name|COLLECTION_CACHE_LOCK_NAME
init|=
literal|"CollectionCache"
decl_stmt|;
specifier|public
name|ManagedLock
name|acquireCollectionCacheLock
parameter_list|()
throws|throws
name|LockException
block|{
...
name|LockException
argument_list|(
literal|"Unable to acquire CollectionCache LOCK"
argument_list|,
name|e
argument_list|)
throw|;
