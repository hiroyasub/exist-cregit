...
return|;
block|}
comment|/**      * @deprecated Use {@link #acquire(LockMode)}      */
annotation|@
name|Override
specifier|public
name|boolean
...
block|}
block|}
comment|/**      * @deprecated Use {@link #release(LockMode)}      */
specifier|public
name|void
name|release
parameter_list|()
...
name|warn
argument_list|(
literal|"Released with LockMode.NO_LOCK and count="
operator|+
name|count
operator|+
literal|"!"
