...
name|pool
decl_stmt|;
comment|/**      * Either a TraceableSubjectChange when logging is set to TRACE level or      * just a Subject      */
specifier|private
name|Deque
argument_list|<
name|Either
...
name|Subject
argument_list|>
name|traceableSubjectOrSubject
parameter_list|)
block|{
return|return
name|traceableSubjectOrSubject
...
name|format
argument_list|(
literal|"%s: pushSubject(%s) from: %s %s"
argument_list|,
name|getId
argument_list|()
argument_list|,
...
name|format
argument_list|(
literal|"%s: popSubject(%s) from: %s %s"
argument_list|,
name|getId
argument_list|()
argument_list|,
