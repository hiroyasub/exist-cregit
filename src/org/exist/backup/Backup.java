...
argument_list|()
decl_stmt|;
comment|// if the collection has a configuration resource, it needs to be stored
comment|// first. Otherwise, the index settings would not be available during restore.
name|Resource
name|config
init|=
name|current
