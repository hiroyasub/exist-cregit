...
specifier|final
name|boolean
name|DEFAULT_DEDUPLICATE_BLOBS_OPTION
init|=
literal|false
decl_stmt|;
specifier|private
...
specifier|final
name|NamedThreadGroupFactory
name|backupThreadGroupFactory
init|=
operator|new
name|NamedThreadGroupFactory
argument_list|(
literal|"java-backup-tool"
argument_list|)
decl_stmt|;
specifier|private
specifier|final
name|ThreadGroup
name|backupThreadGroup
init|=
name|backupThreadGroupFactory
operator|.
name|newThreadGroup
...
argument_list|()
expr_stmt|;
comment|//super("exist-backupThread-" + backupThreadId.getAndIncrement());
if|if
condition|(
name|parent
operator|==
...
condition|)
block|{
comment|// only add distinct blobs to the Blob Store once!
specifier|final
name|String
name|blobId
init|=
...
block|}
block|}
comment|/**      * Create a new thread for this backup instance.      *      * @param threadName the name of the thread      * @param runnable   the function to execute on the thread      * @return the thread      */
specifier|private
name|Thread
name|newBackupThread
parameter_list|(
