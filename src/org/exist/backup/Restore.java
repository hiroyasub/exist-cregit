...
expr_stmt|;
block|}
comment|//            BackupDescriptor rootDesc = getBackupDescriptor(f);
comment|//            File repoBackup = rootDesc.getRepoBackup();
comment|//            // repoBackup should be null unless we're doing a full restore
comment|//            if (repoBackup != null) {
comment|//                restorePkgRepo(listener, repoBackup, uri, username, password);
comment|//            }
block|}
finally|finally
block|{
