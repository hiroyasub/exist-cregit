...
argument_list|)
expr_stmt|;
comment|//TODO consider an exception here!
block|}
specifier|final
name|String
name|owner
...
name|append
argument_list|(
literal|"Warnings were found during restore:\n"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|warn
argument_list|(
literal|"Failed to change owner on collection skipping ..."
argument_list|)
expr_stmt|;
block|}
block|}
...
name|warn
argument_list|(
literal|"Failed to change owner on document skipping ..."
argument_list|)
expr_stmt|;
block|}
block|}
