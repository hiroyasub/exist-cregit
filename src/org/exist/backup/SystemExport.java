...
expr_stmt|;
block|}
comment|/**      * Export the contents of the database, trying to preserve      * as much data as possible. To be effective, this method      * should be used in combination with class      * {@link ConsistencyCheck}.      *      * @param target the output directory or file to which data will be written.      *  Output will be written to a zip file if target ends with .zip.      * @param errorList a list of {@link ErrorReport} objects as returned by      *   methods in {@link ConsistencyCheck}.      */
specifier|public
name|void
name|export
parameter_list|(
...
block|}
block|}
comment|/**      * Export a collection. Write out the collection metadata and save the resources stored in      * the collection.      *      * @param current the collection      * @param output the output writer      * @param errorList a list of {@link ErrorReport} objects as returned by      *   methods in {@link ConsistencyCheck}      * @param docs a document set to keep track of all written documents.      * @throws IOException      * @throws SAXException      */
specifier|private
name|void
name|export
parameter_list|(
