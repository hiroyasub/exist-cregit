...
name|count
decl_stmt|;
comment|/** Flag to indicate if the buffers can be reused after reset */
specifier|private
name|boolean
name|reuseBuffers
init|=
...
expr_stmt|;
block|}
comment|/**      * Writes the entire contents of the specified input stream to this      * byte stream. Bytes from the input stream are read directly into the      * internal buffers of this streams.      *      * @param in the input stream to read from      * @return total number of bytes read from the input stream      *         (and written to this stream)      * @throws IOException if an I/O error occurs while reading the input stream      * @since 1.4      */
specifier|public
comment|/*synchronized*/
name|int
name|write
...
return|;
block|}
comment|/**      * Closing a {@code ByteArrayOutputStream} has no effect. The methods in      * this class can be called after the stream has been closed without      * generating an {@code IOException}.      *      * @throws IOException never (this method should not declare this exception      * but it has to now due to backwards compatibility)      */
annotation|@
name|Override
specifier|public
name|void
...
block|{
comment|//Throw away old buffers
name|currentBuffer
operator|=
literal|null
expr_stmt|;
...
name|IOException
block|{
comment|// It does not matter if a ByteArrayOutputStream is not closed as close() is a no-op
annotation|@
...
return|;
block|}
comment|/**      * Gets the current contents of this byte stream as a Input Stream. The      * returned stream is backed by buffers of<code>this</code> stream,      * avoiding memory allocation and copy, thus saving space and time.<br>      *      * @return the current contents of this output stream.      * @see java.io.ByteArrayOutputStream#toByteArray()      * @see #reset()      * @since 2.5      */
specifier|public
comment|/*synchronized*/
name|InputStream
name|toInputStream
...
return|;
block|}
comment|/**      * Gets the current contents of this byte stream as a byte array.      * The result is independent of this stream.      *      * @return the current contents of this output stream, as a byte array      * @see java.io.ByteArrayOutputStream#toByteArray()      */
specifier|public
comment|/*synchronized*/
name|byte
index|[]
...
return|;
block|}
comment|/**      * Gets the current contents of this byte stream as a string      * using the platform default charset.      * @return the contents of the byte array as a String      * @see java.io.ByteArrayOutputStream#toString()      * @deprecated 2.5 use {@link #toString(String)} instead      */
annotation|@
name|Override
annotation|@
name|Deprecated
...
parameter_list|()
block|{
comment|// make explicit the use of the default charset
return|return
operator|new
name|String
argument_list|(
...
return|;
block|}
comment|/**      * Gets the current contents of this byte stream as a string      * using the specified encoding.      *      * @param charset  the character encoding      * @return the string converted from the byte array      * @see java.io.ByteArrayOutputStream#toString(String)      * @since 2.5      */
specifier|public
name|String
name|toString
parameter_list|(
