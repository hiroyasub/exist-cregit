...
return|;
block|}
comment|/**      * Returns a file handle for eXist's home directory.      *<p>      * If either the proposed home directory does not exist, does not contain a      * configuration file or none of the directories identified by the system properties      *<code>exist.home</code> and<code>user.home</code> exist or none of      * them contains a configuration file, this method returns<code>null</code>.      *       * @param path path to eXist home directory      * @return the file handle or<code>null</code>      */
specifier|public
specifier|static
name|File
name|getExistHome
...
name|info
argument_list|(
literal|"Environment variabe 'exist.home' not set. Trying webapp configuration "
operator|+
name|home
operator|+
literal|" ..."
...
name|info
argument_list|(
literal|"Webapp configuration not found. Trying home directory "
operator|+
name|home
operator|+
literal|" ..."
...
name|info
argument_list|(
literal|"No configuration file found in the home directory. Trying working directory "
operator|+
name|home
operator|+
literal|" ..."
...
name|info
argument_list|(
literal|"No configuration file found in the home directory. Giving up ..."
argument_list|)
expr_stmt|;
throw|throw
operator|new
...
name|info
argument_list|(
literal|"Configuring eXist using "
operator|+
name|config
argument_list|)
expr_stmt|;
