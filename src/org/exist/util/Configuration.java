...
name|info
argument_list|(
literal|"Environment variabe 'exist.home' not set."
argument_list|)
expr_stmt|;
name|home
operator|=
...
name|info
argument_list|(
literal|"Trying home directory '"
operator|+
name|home
operator|+
literal|"' to locate eXist configuration ..."
argument_list|)
expr_stmt|;
block|}
if|else if
...
block|}
block|}
comment|// check if we found an existing directory
name|File
name|homeDir
init|=
operator|new
...
name|warn
argument_list|(
literal|"Unable to find exist home directory: "
operator|+
name|home
operator|+
...
name|info
argument_list|(
literal|"Trying working directory '"
operator|+
name|homeDir
operator|+
literal|"' to locate eXist configuration ..."
...
expr_stmt|;
block|}
comment|// see if the config file is there...
name|File
name|config
init|=
operator|new
