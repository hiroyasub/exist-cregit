...
begin_comment
comment|/**  *  Description of the Class  *  *@author     Wolfgang Meier<meier@ifs.tu-darmstadt.de>  *@created    July 31, 2002  */
end_comment
...
expr_stmt|;
block|}
comment|/** 	 *  Adds a feature to the Term attribute of the FunContains object 	 * 	 *@param  arg  The feature to be added to the Term attribute 	 */
specifier|public
name|void
name|addTerm
parameter_list|(
