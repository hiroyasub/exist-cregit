...
name|create
argument_list|(
literal|"/db/overwrite-collection-fs-dir-test"
argument_list|)
decl_stmt|;
specifier|final
name|XmldbURI
...
init|)
block|{
comment|// create a folder in the storage which will represent an orphaned collection folder
specifier|final
name|Collection
name|testCollection
init|=
...
argument_list|)
expr_stmt|;
comment|// attempt to create a binary document with the same uri as the orphaned thingCollection (should fail)
specifier|final
name|byte
index|[]
name|binaryData
...
name|assertEquals
argument_list|(
literal|"Cannot overwrite binary fs Collection '"
operator|+
name|thingUri
operator|.
name|getRawCollectionPath
