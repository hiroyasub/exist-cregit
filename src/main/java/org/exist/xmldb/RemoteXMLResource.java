...
literal|null
decl_stmt|;
comment|/**      * @deprecated Use {@link #RemoteXMLResource(Leasable.Lease, RemoteCollection, XmldbURI, Optional, Optional)}.      */
annotation|@
name|Deprecated
specifier|public
name|RemoteXMLResource
...
expr_stmt|;
block|}
comment|/**      * @deprecared Use {@link #RemoteXMLResource(Leasable.Lease, RemoteCollection, int, int, XmldbURI, Optional, Optional)}.      */
annotation|@
name|Deprecated
specifier|public
name|RemoteXMLResource
