...
literal|102
decl_stmt|;
comment|// "no-preserve" = 103
name|int
name|LITERAL_inherit
init|=
literal|104
decl_stmt|;
comment|// "no-inherit" = 105
name|int
name|DOLLAR
init|=
literal|106
...
literal|192
decl_stmt|;
comment|// "namespace-node" = 193
comment|// "processing-instruction" = 194
comment|// "document-node" = 195
name|int
...
literal|208
decl_stmt|;
comment|// "descendant-or-self" = 209
comment|// "following-sibling" = 210
name|int
name|LITERAL_parent
init|=
literal|211
...
literal|212
decl_stmt|;
comment|// "ancestor-or-self" = 213
comment|// "preceding-sibling" = 214
name|int
name|ARROW_OP
init|=
literal|215
