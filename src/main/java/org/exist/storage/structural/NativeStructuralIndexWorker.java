...
return|;
block|}
comment|/**      * Scan the document set to find document id ranges to query      *      * @param docs      * @return List of contiguous document id ranges      */
name|List
argument_list|<
name|Range
argument_list|>
...
block|}
comment|/**      * Collect index statistics. Used by functions like util:index-keys.      *      * @param context      * @param docs The documents to which the index entries belong      * @param contextSet ignored by this index      * @param hints Some "hints" for retrieving the index entries. See such hints in      * {@link org.exist.indexing.OrderedValuesIndex} and {@link org.exist.indexing.QNamedKeysIndex}.      * @return      */
specifier|public
name|Occurrences
index|[]
name|scanIndex
