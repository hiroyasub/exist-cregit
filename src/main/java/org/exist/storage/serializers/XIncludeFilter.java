...
begin_comment
comment|/**  * A filter that listens for XInclude elements in the stream  * of events generated by the {@link org.exist.storage.serializers.Serializer}.  *<p>  * XInclude elements are expanded at the position where they were found.  */
end_comment
...
block|}
comment|/**      * @param href     The resource to be xincluded      * @param xpointer The xpointer      * @return Optionally a ResourceError if it was not possible to retrieve the resource      * to be xincluded      * @throws SAXException              If a SAX processing error occurs      */
specifier|protected
name|Optional
argument_list|<
name|ResourceError
...
name|SAXException
argument_list|(
literal|"Fragment identifiers must not be used in an xinclude href attribute. To specify an xpointer, use the xpointer attribute."
argument_list|)
throw|;
block|}
...
name|ResourceError
argument_list|(
literal|"Permission denied to read XInclude'd resource"
argument_list|,
name|e
argument_list|)
argument_list|)
...
name|ResourceError
argument_list|(
literal|"Permission denied on XInclude'd resource"
argument_list|,
name|e
argument_list|)
argument_list|)
